...
public class StrawberryBushGrownBlock extends WildfarmcraftModElements.ModElement {
	@ObjectHolder("wildfarmcraft:strawberry_bush_grown")
	public static final Block block = null;
	public StrawberryBushGrownBlock(WildfarmcraftModElements instance) {
		super(instance, 428);
	}
	...
	public static class BlockCustomFlower extends FlowerBlock {
		public BlockCustomFlower() {
			...
			setRegistryName("strawberry_bush_grown");
		}
