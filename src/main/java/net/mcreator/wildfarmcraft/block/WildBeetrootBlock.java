...
import net.mcreator.wildfarmcraft.procedures.WildBeetrootGenCondiProcedure;
...
public class WildBeetrootBlock extends WildfarmcraftModElements.ModElement {
	@ObjectHolder("wildfarmcraft:wild_beetroot")
	public static final Block block = null;
	public WildBeetrootBlock(WildfarmcraftModElements instance) {
		super(instance, 501);
		...
		public void registerFeature(RegistryEvent.Register<Feature<?>> event) {
			feature = new DefaultFlowersFeature(BlockClusterFeatureConfig.field_236587_a_) {
				...
				public boolean generate(ISeedReader world, ChunkGenerator generator, Random random, BlockPos pos, BlockClusterFeatureConfig config) {
					...
					int y = pos.getY();
					int z = pos.getZ();
					if (!WildBeetrootGenCondiProcedure.executeProcedure(ImmutableMap.of("x", x, "y", y, "z", z, "world", world)))
						return false;
			...
			event.getRegistry().register(feature.setRegistryName("wild_beetroot"));
			Registry.register(WorldGenRegistries.CONFIGURED_FEATURE, new ResourceLocation("wildfarmcraft:wild_beetroot"), configuredFeature);
		}
	}
	@SubscribeEvent
