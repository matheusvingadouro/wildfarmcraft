...
import net.mcreator.wildfarmcraft.procedures.CropGrowthProcedure;
...
public class PastureBlock extends WildfarmcraftModElements.ModElement {
	@ObjectHolder("wildfarmcraft:pasture")
	public static final Block block = null;
	public PastureBlock(WildfarmcraftModElements instance) {
		super(instance, 69);
	...
	public static class BlockCustomFlower extends FlowerBlock {
		...
		public List<ItemStack> getDrops(BlockState state, LootContext.Builder builder) {
			...
			return Collections.singletonList(new ItemStack(PastureSeedItem.block, (int) (1)));
		}
		...
		public void tick(BlockState state, ServerWorld world, BlockPos pos, Random random) {
			...
			int z = pos.getZ();
			{
				...
				CropGrowthProcedure.executeProcedure($_dependencies);
			}
		}
	}
}
