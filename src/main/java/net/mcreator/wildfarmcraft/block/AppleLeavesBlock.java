...
public class AppleLeavesBlock extends WildfarmcraftModElements.ModElement {
	@ObjectHolder("wildfarmcraft:apple_leaves")
	public static final Block block = null;
	public AppleLeavesBlock(WildfarmcraftModElements instance) {
		super(instance, 315);
