...
import net.mcreator.wildfarmcraft.procedures.WildCarrotsGenCondiProcedure;
...
public class WildCarrotsBlock extends WildfarmcraftModElements.ModElement {
	@ObjectHolder("wildfarmcraft:wild_carrots")
	public static final Block block = null;
	public WildCarrotsBlock(WildfarmcraftModElements instance) {
		super(instance, 503);
		...
		public void registerFeature(RegistryEvent.Register<Feature<?>> event) {
			feature = new DefaultFlowersFeature(BlockClusterFeatureConfig.field_236587_a_) {
				...
				public boolean generate(ISeedReader world, ChunkGenerator generator, Random random, BlockPos pos, BlockClusterFeatureConfig config) {
					...
					int y = pos.getY();
					int z = pos.getZ();
					if (!WildCarrotsGenCondiProcedure.executeProcedure(ImmutableMap.of("x", x, "y", y, "z", z, "world", world)))
						return false;
			...
			event.getRegistry().register(feature.setRegistryName("wild_carrots"));
			Registry.register(WorldGenRegistries.CONFIGURED_FEATURE, new ResourceLocation("wildfarmcraft:wild_carrots"), configuredFeature);
		}
	}
	@SubscribeEvent
