...
import net.mcreator.wildfarmcraft.procedures.StrawberryGrowthProcedure;
import net.mcreator.wildfarmcraft.procedures.StrawberryGenCondiProcedure;
...
public class StrawberryBush3Block extends WildfarmcraftModElements.ModElement {
	@ObjectHolder("wildfarmcraft:strawberry_bush_3")
	public static final Block block = null;
	public StrawberryBush3Block(WildfarmcraftModElements instance) {
		super(instance, 427);
		...
		public void registerFeature(RegistryEvent.Register<Feature<?>> event) {
			feature = new DefaultFlowersFeature(BlockClusterFeatureConfig.field_236587_a_) {
				...
				public boolean generate(ISeedReader world, ChunkGenerator generator, Random random, BlockPos pos, BlockClusterFeatureConfig config) {
					...
					int y = pos.getY();
					int z = pos.getZ();
					if (!StrawberryGenCondiProcedure.executeProcedure(ImmutableMap.of("x", x, "y", y, "z", z, "world", world)))
						return false;
			...
			event.getRegistry().register(feature.setRegistryName("strawberry_bush_3"));
			Registry.register(WorldGenRegistries.CONFIGURED_FEATURE, new ResourceLocation("wildfarmcraft:strawberry_bush_3"), configuredFeature);
		}
	}
	@SubscribeEvent
	...
	public static class BlockCustomFlower extends FlowerBlock {
		...
		public void tick(BlockState state, ServerWorld world, BlockPos pos, Random random) {
			...
			int z = pos.getZ();
			{
				...
				StrawberryGrowthProcedure.executeProcedure($_dependencies);
			}
		}
	}
}
