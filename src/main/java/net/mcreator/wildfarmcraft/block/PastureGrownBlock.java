...
public class PastureGrownBlock extends WildfarmcraftModElements.ModElement {
	@ObjectHolder("wildfarmcraft:pasture_grown")
	public static final Block block = null;
	public PastureGrownBlock(WildfarmcraftModElements instance) {
		super(instance, 67);
	...
	private static class FeatureRegisterHandler {
		...
		public void registerFeature(RegistryEvent.Register<Feature<?>> event) {
			...
			event.getRegistry().register(feature.setRegistryName("pasture_grown"));
			Registry.register(WorldGenRegistries.CONFIGURED_FEATURE, new ResourceLocation("wildfarmcraft:pasture_grown"), configuredFeature);
		}
	}
	@SubscribeEvent
	...
	public static class BlockCustomFlower extends FlowerBlock {
		...
		public ItemStack getPickBlock(BlockState state, RayTraceResult target, IBlockReader world, BlockPos pos, PlayerEntity player) {
			return new ItemStack(PastureSeedItem.block, (int) (1));
		}
		...
		public List<ItemStack> getDrops(BlockState state, LootContext.Builder builder) {
			...
			return Collections.singletonList(new ItemStack(PastureSeedItem.block, (int) (3)));
		}
