...
public class StrawberryBush2Block extends WildfarmcraftModElements.ModElement {
	@ObjectHolder("wildfarmcraft:strawberry_bush_2")
	public static final Block block = null;
	public StrawberryBush2Block(WildfarmcraftModElements instance) {
		super(instance, 426);
