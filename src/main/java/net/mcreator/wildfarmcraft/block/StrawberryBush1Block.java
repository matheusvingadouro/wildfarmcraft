...
public class StrawberryBush1Block extends WildfarmcraftModElements.ModElement {
	@ObjectHolder("wildfarmcraft:strawberry_bush_1")
	public static final Block block = null;
	public StrawberryBush1Block(WildfarmcraftModElements instance) {
		super(instance, 423);
	...
	public static class BlockCustomFlower extends FlowerBlock {
		public BlockCustomFlower() {
			...
			setRegistryName("strawberry_bush_1");
		}
