...
import net.mcreator.wildfarmcraft.procedures.WildPotatoesGenCondiProcedure;
...
public class WildPotatoesBlock extends WildfarmcraftModElements.ModElement {
	@ObjectHolder("wildfarmcraft:wild_potatoes")
	public static final Block block = null;
	public WildPotatoesBlock(WildfarmcraftModElements instance) {
		super(instance, 499);
		...
		public void registerFeature(RegistryEvent.Register<Feature<?>> event) {
			feature = new DefaultFlowersFeature(BlockClusterFeatureConfig.field_236587_a_) {
				...
				public boolean generate(ISeedReader world, ChunkGenerator generator, Random random, BlockPos pos, BlockClusterFeatureConfig config) {
					...
					int y = pos.getY();
					int z = pos.getZ();
					if (!WildPotatoesGenCondiProcedure.executeProcedure(ImmutableMap.of("x", x, "y", y, "z", z, "world", world)))
						return false;
			...
			event.getRegistry().register(feature.setRegistryName("wild_potatoes"));
			Registry.register(WorldGenRegistries.CONFIGURED_FEATURE, new ResourceLocation("wildfarmcraft:wild_potatoes"), configuredFeature);
		}
	}
	@SubscribeEvent
