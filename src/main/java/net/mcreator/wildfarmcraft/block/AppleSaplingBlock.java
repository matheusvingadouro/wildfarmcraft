...
import net.mcreator.wildfarmcraft.procedures.SapplingGrowthProcedure;
...
public class AppleSaplingBlock extends WildfarmcraftModElements.ModElement {
	@ObjectHolder("wildfarmcraft:apple_sapling")
	public static final Block block = null;
	public AppleSaplingBlock(WildfarmcraftModElements instance) {
		super(instance, 323);
	}
	...
	public static class BlockCustomFlower extends FlowerBlock {
		...
		public void tick(BlockState state, ServerWorld world, BlockPos pos, Random random) {
			...
			int z = pos.getZ();
			{
				...
				SapplingGrowthProcedure.executeProcedure($_dependencies);
			}
		}
	}
}
