...
public class AppleStage1Block extends WildfarmcraftModElements.ModElement {
	@ObjectHolder("wildfarmcraft:apple_stage_1")
	public static final Block block = null;
	public AppleStage1Block(WildfarmcraftModElements instance) {
		super(instance, 325);
	}
