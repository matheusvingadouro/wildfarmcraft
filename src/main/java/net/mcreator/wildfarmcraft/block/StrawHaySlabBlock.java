...
public class StrawHaySlabBlock extends WildfarmcraftModElements.ModElement {
	@ObjectHolder("wildfarmcraft:straw_hay_slab")
	public static final Block block = null;
	public StrawHaySlabBlock(WildfarmcraftModElements instance) {
		super(instance, 22);
	}
	...
	public static class CustomBlock extends SlabBlock {
		public CustomBlock() {
			...
			setRegistryName("straw_hay_slab");
		}
		...
		public List<ItemStack> getDrops(BlockState state, LootContext.Builder builder) {
			...
			return Collections.singletonList(new ItemStack(PastureSeedItem.block, (int) (2)));
		}
	}
}
