...
public class CookedEggItem extends WildfarmcraftModElements.ModElement {
	@ObjectHolder("wildfarmcraft:cooked_egg")
	public static final Item block = null;
	public CookedEggItem(WildfarmcraftModElements instance) {
		super(instance, 192);
	}
