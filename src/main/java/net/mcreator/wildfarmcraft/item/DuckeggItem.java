...
public class DuckeggItem extends WildfarmcraftModElements.ModElement {
	@ObjectHolder("wildfarmcraft:duckegg")
	public static final Item block = null;
	public DuckeggItem(WildfarmcraftModElements instance) {
		super(instance, 23);
	}
