...
public class TurkeyEggItem extends WildfarmcraftModElements.ModElement {
	@ObjectHolder("wildfarmcraft:turkey_egg")
	public static final Item block = null;
	public TurkeyEggItem(WildfarmcraftModElements instance) {
		super(instance, 211);
	}
