...
public class DomesticTurkeyFemaleTickUpdateProcedure extends WildfarmcraftModElements.ModElement {
	public DomesticTurkeyFemaleTickUpdateProcedure(WildfarmcraftModElements instance) {
		super(instance, 208);
	}
	...
	public static void executeProcedure(Map<String, Object> dependencies) {
		if (dependencies.get("entity") == null) {
			if (!dependencies.containsKey("entity"))
				WildfarmcraftMod.LOGGER.warn("Failed to load dependency entity for procedure DomesticTurkeyFemaleTickUpdate!");
			return;
		}
		if (dependencies.get("x") == null) {
			if (!dependencies.containsKey("x"))
				WildfarmcraftMod.LOGGER.warn("Failed to load dependency x for procedure DomesticTurkeyFemaleTickUpdate!");
			return;
		}
		if (dependencies.get("y") == null) {
			if (!dependencies.containsKey("y"))
				WildfarmcraftMod.LOGGER.warn("Failed to load dependency y for procedure DomesticTurkeyFemaleTickUpdate!");
			return;
		}
		if (dependencies.get("z") == null) {
			if (!dependencies.containsKey("z"))
				WildfarmcraftMod.LOGGER.warn("Failed to load dependency z for procedure DomesticTurkeyFemaleTickUpdate!");
			return;
		}
		if (dependencies.get("world") == null) {
			if (!dependencies.containsKey("world"))
				WildfarmcraftMod.LOGGER.warn("Failed to load dependency world for procedure DomesticTurkeyFemaleTickUpdate!");
			return;
		}
				...
				if (((entity.getPersistentData().getDouble("Stomach")) >= 10)) {
					...
					if (((entity.getPersistentData().getBoolean("IsMated")) == (true))) {
						if (world instanceof ServerWorld) {
							Entity entityToSpawn = new TurkeyNestEntity.CustomEntity(TurkeyNestEntity.entity, (World) world);
						...
						if ((((Entity) world
								.getEntitiesWithinAABB(TurkeyNestEntity.CustomEntity.class,
							...
							entity.startRiding(((Entity) world.getEntitiesWithinAABB(TurkeyNestEntity.CustomEntity.class,
									new AxisAlignedBB(x - (4 / 2d), y - (4 / 2d), z - (4 / 2d), x + (4 / 2d), y + (4 / 2d), z + (4 / 2d)), null)
									.stream().sorted(new Object() {
										Comparator<Entity> compareDistOf(double _x, double _y, double _z) {
											return Comparator.comparing((Function<Entity, Double>) (_entcnd -> _entcnd.getDistanceSq(_x, _y, _z)));
			...
			if (((entity.getPersistentData().getDouble("Stomach")) >= 30)) {
				{
					...
					TurkeySetPartnerProcedure.executeProcedure($_dependencies);
				}
			}
		}
		{
