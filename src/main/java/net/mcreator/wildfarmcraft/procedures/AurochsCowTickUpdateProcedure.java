...
public class AurochsCowTickUpdateProcedure extends WildfarmcraftModElements.ModElement {
	public AurochsCowTickUpdateProcedure(WildfarmcraftModElements instance) {
		super(instance, 111);
	}
	...
	public static void executeProcedure(Map<String, Object> dependencies) {
		if (dependencies.get("entity") == null) {
			if (!dependencies.containsKey("entity"))
				WildfarmcraftMod.LOGGER.warn("Failed to load dependency entity for procedure AurochsCowTickUpdate!");
			return;
		}
		if (dependencies.get("x") == null) {
			if (!dependencies.containsKey("x"))
				WildfarmcraftMod.LOGGER.warn("Failed to load dependency x for procedure AurochsCowTickUpdate!");
			return;
		}
		if (dependencies.get("y") == null) {
			if (!dependencies.containsKey("y"))
				WildfarmcraftMod.LOGGER.warn("Failed to load dependency y for procedure AurochsCowTickUpdate!");
			return;
		}
		if (dependencies.get("z") == null) {
			if (!dependencies.containsKey("z"))
				WildfarmcraftMod.LOGGER.warn("Failed to load dependency z for procedure AurochsCowTickUpdate!");
			return;
		}
		if (dependencies.get("world") == null) {
			if (!dependencies.containsKey("world"))
				WildfarmcraftMod.LOGGER.warn("Failed to load dependency world for procedure AurochsCowTickUpdate!");
			return;
		}
		...
		if (((entity.getPersistentData().getBoolean("isPregnant")) == (false))) {
			if (((entity.getPersistentData().getDouble("Stomach")) >= 100)) {
				...
				if ((((entity.getPersistentData().getString("Partner"))).equals("Aurochs"))) {
					if ((Math.random() < 0.9)) {
					...
					if ((((entity.getPersistentData().getString("Partner"))).equals("Bison"))) {
						if ((Math.random() < 0.5)) {
							entity.getPersistentData().putString("BabySpecie", "Aurochs");
						} else {
				...
				if ((((entity.getPersistentData().getString("BabySpecie"))).equals("RandomDomestic"))) {
					{
						...
						$_dependencies.put("z", z);
						$_dependencies.put("world", world);
						WildCowSetRandomBabyProcedure.executeProcedure($_dependencies);
					}
				}
			}
		}
