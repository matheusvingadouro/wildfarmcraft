...
public class HolsteinCowOnEntityTickUpdateProcedure extends WildfarmcraftModElements.ModElement {
	public HolsteinCowOnEntityTickUpdateProcedure(WildfarmcraftModElements instance) {
		super(instance, 28);
	}
	...
	public static void executeProcedure(Map<String, Object> dependencies) {
		if (dependencies.get("entity") == null) {
			if (!dependencies.containsKey("entity"))
				WildfarmcraftMod.LOGGER.warn("Failed to load dependency entity for procedure HolsteinCowOnEntityTickUpdate!");
			return;
		}
		if (dependencies.get("x") == null) {
			if (!dependencies.containsKey("x"))
				WildfarmcraftMod.LOGGER.warn("Failed to load dependency x for procedure HolsteinCowOnEntityTickUpdate!");
			return;
		}
		if (dependencies.get("y") == null) {
			if (!dependencies.containsKey("y"))
				WildfarmcraftMod.LOGGER.warn("Failed to load dependency y for procedure HolsteinCowOnEntityTickUpdate!");
			return;
		}
		if (dependencies.get("z") == null) {
			if (!dependencies.containsKey("z"))
				WildfarmcraftMod.LOGGER.warn("Failed to load dependency z for procedure HolsteinCowOnEntityTickUpdate!");
			return;
		}
		if (dependencies.get("world") == null) {
			if (!dependencies.containsKey("world"))
				WildfarmcraftMod.LOGGER.warn("Failed to load dependency world for procedure HolsteinCowOnEntityTickUpdate!");
			return;
		}
		...
		if (((entity.getPersistentData().getDouble("MilkAmount")) < 5)) {
			...
			if (((entity.getPersistentData().getDouble(
					"ProducingMilk")) >= ((world.getWorldInfo().getGameRulesInstance().getInt(WfcAnimalProductionTimeGameRule.gamerule)) / 2))) {
