...
public class ChickIsHurtProcedure extends WildfarmcraftModElements.ModElement {
	public ChickIsHurtProcedure(WildfarmcraftModElements instance) {
		super(instance, 286);
	}
	...
	public static void executeProcedure(Map<String, Object> dependencies) {
		if (dependencies.get("x") == null) {
			if (!dependencies.containsKey("x"))
				WildfarmcraftMod.LOGGER.warn("Failed to load dependency x for procedure ChickIsHurt!");
			return;
		}
		if (dependencies.get("y") == null) {
			if (!dependencies.containsKey("y"))
				WildfarmcraftMod.LOGGER.warn("Failed to load dependency y for procedure ChickIsHurt!");
			return;
		}
		if (dependencies.get("z") == null) {
			if (!dependencies.containsKey("z"))
				WildfarmcraftMod.LOGGER.warn("Failed to load dependency z for procedure ChickIsHurt!");
			return;
		}
		if (dependencies.get("world") == null) {
			if (!dependencies.containsKey("world"))
				WildfarmcraftMod.LOGGER.warn("Failed to load dependency world for procedure ChickIsHurt!");
			return;
		}
							...
							.stream().sorted(new Object() {
								Comparator<Entity> compareDistOf(double _x, double _y, double _z) {
									...
									? ((TameableEntity) ((Entity) world
											.getEntitiesWithinAABB(RedRhodeHenEntity.CustomEntity.class, new AxisAlignedBB(x - (20 / 2d),
						...
						&& (!((((Entity) world.getEntitiesWithinAABB(JunglefowlFemaleEntity.CustomEntity.class,
								...
								.stream().sorted(new Object() {
									Comparator<Entity> compareDistOf(double _x, double _y, double _z) {
										...
										? ((TameableEntity) ((Entity) world
												.getEntitiesWithinAABB(JunglefowlFemaleEntity.CustomEntity.class, new AxisAlignedBB(x - (20 / 2d),
														y - (20 / 2d), z - (20 / 2d), x + (20 / 2d), y + (20 / 2d), z + (20 / 2d)), null)
												.stream().sorted(new Object() {
													Comparator<Entity> compareDistOf(double _x, double _y, double _z) {
														return Comparator
					...
					if (((((Entity) world
							...
							&& (!((((Entity) world.getEntitiesWithinAABB(LeghornHenEntity.CustomEntity.class,
									...
									.findFirst().orElse(null)) instanceof TameableEntity)
											? ((TameableEntity) ((Entity) world
													.getEntitiesWithinAABB(LeghornHenEntity.CustomEntity.class, new AxisAlignedBB(x - (20 / 2d),
															y - (20 / 2d), z - (20 / 2d), x + (20 / 2d), y + (20 / 2d), z + (20 / 2d)), null)
													.stream().sorted(new Object() {
														Comparator<Entity> compareDistOf(double _x, double _y, double _z) {
