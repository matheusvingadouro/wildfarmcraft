...
public class DuckNestOnEntityTickUpdateProcedure extends WildfarmcraftModElements.ModElement {
	public DuckNestOnEntityTickUpdateProcedure(WildfarmcraftModElements instance) {
		super(instance, 56);
	}
	...
	public static void executeProcedure(Map<String, Object> dependencies) {
		if (dependencies.get("entity") == null) {
			if (!dependencies.containsKey("entity"))
				WildfarmcraftMod.LOGGER.warn("Failed to load dependency entity for procedure DuckNestOnEntityTickUpdate!");
			return;
		}
		if (dependencies.get("x") == null) {
			if (!dependencies.containsKey("x"))
				WildfarmcraftMod.LOGGER.warn("Failed to load dependency x for procedure DuckNestOnEntityTickUpdate!");
			return;
		}
		if (dependencies.get("y") == null) {
			if (!dependencies.containsKey("y"))
				WildfarmcraftMod.LOGGER.warn("Failed to load dependency y for procedure DuckNestOnEntityTickUpdate!");
			return;
		}
		if (dependencies.get("z") == null) {
			if (!dependencies.containsKey("z"))
				WildfarmcraftMod.LOGGER.warn("Failed to load dependency z for procedure DuckNestOnEntityTickUpdate!");
			return;
		}
		if (dependencies.get("world") == null) {
			if (!dependencies.containsKey("world"))
				WildfarmcraftMod.LOGGER.warn("Failed to load dependency world for procedure DuckNestOnEntityTickUpdate!");
			return;
		}
		...
		if (((((((Entity) world
			...
			if (((entity.getPersistentData()
				...
				if ((((entity.getPersistentData().getString("Specie"))).equals("Brown"))) {
					for (int index0 = 0; index0 < (int) (3); index0++) {
						if (world instanceof ServerWorld) {
							Entity entityToSpawn = new BrownDucklingEntity.CustomEntity(BrownDucklingEntity.entity, (World) world);
				...
				if ((((entity.getPersistentData().getString("Specie"))).equals("Pekin"))) {
					for (int index1 = 0; index1 < (int) (3); index1++) {
						if (world instanceof ServerWorld) {
							Entity entityToSpawn = new PekinDucklingEntity.CustomEntity(PekinDucklingEntity.entity, (World) world);
							entityToSpawn.setLocationAndAngles(x, y, z, world.getRandom().nextFloat() * 360F, 0);
							if (entityToSpawn instanceof MobEntity)
								((MobEntity) entityToSpawn).onInitialSpawn((ServerWorld) world,
										world.getDifficultyForLocation(entityToSpawn.getPosition()), SpawnReason.MOB_SUMMONED,
				...
				if ((((entity.getPersistentData().getString("Specie"))).equals("Wild"))) {
					if ((Math.random() < 0.9)) {
						for (int index2 = 0; index2 < (int) (3); index2++) {
							if (world instanceof ServerWorld) {
								Entity entityToSpawn = new WildDucklingEntity.CustomEntity(WildDucklingEntity.entity, (World) world);
								entityToSpawn.setLocationAndAngles(x, y, z, world.getRandom().nextFloat() * 360F, 0);
								if (entityToSpawn instanceof MobEntity)
									((MobEntity) entityToSpawn).onInitialSpawn((ServerWorld) world,
											world.getDifficultyForLocation(entityToSpawn.getPosition()), SpawnReason.MOB_SUMMONED,
							...
							Comparator<Entity> compareDistOf(double _x, double _y, double _z) {
								...
								null)) instanceof TameableEntity)
										? ((TameableEntity) ((Entity) world
												.getEntitiesWithinAABB(PekinDuckFemaleEntity.CustomEntity.class, new AxisAlignedBB(x - (4 / 2d),
				...
				if (((!((((Entity) world
						...
						.stream().sorted(new Object() {
							Comparator<Entity> compareDistOf(double _x, double _y, double _z) {
								...
								null)) instanceof TameableEntity)
										? ((TameableEntity) ((Entity) world
												.getEntitiesWithinAABB(WildDuckFemaleEntity.CustomEntity.class, new AxisAlignedBB(x - (4 / 2d),
														y - (4 / 2d), z - (4 / 2d), x + (4 / 2d), y + (4 / 2d), z + (4 / 2d)), null)
												.stream().sorted(new Object() {
													Comparator<Entity> compareDistOf(double _x, double _y, double _z) {
														return Comparator
				...
				if (((!((((Entity) world
						...
						.stream().sorted(new Object() {
							Comparator<Entity> compareDistOf(double _x, double _y, double _z) {
								...
								null)) instanceof TameableEntity)
										? ((TameableEntity) ((Entity) world
												.getEntitiesWithinAABB(BrownDuckFemaleEntity.CustomEntity.class, new AxisAlignedBB(x - (4 / 2d),
														y - (4 / 2d), z - (4 / 2d), x + (4 / 2d), y + (4 / 2d), z + (4 / 2d)), null)
												.stream().sorted(new Object() {
													Comparator<Entity> compareDistOf(double _x, double _y, double _z) {
														return Comparator
