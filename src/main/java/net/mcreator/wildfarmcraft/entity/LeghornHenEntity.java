...
import net.mcreator.wildfarmcraft.procedures.LeghornHenTickUpdateProcedure;
...
import net.mcreator.wildfarmcraft.entity.renderer.LeghornHenRenderer;
...
public class LeghornHenEntity extends WildfarmcraftModElements.ModElement {
	public static EntityType entity = (EntityType.Builder.<CustomEntity>create(CustomEntity::new, EntityClassification.CREATURE)
			.setShouldReceiveVelocityUpdates(true).setTrackingRange(64).setUpdateInterval(3).setCustomClientFactory(CustomEntity::new)
			.size(0.4f, 0.6f)).build("leghorn_hen").setRegistryName("leghorn_hen");
	public LeghornHenEntity(WildfarmcraftModElements instance) {
		super(instance, 183);
		FMLJavaModLoadingContext.get().getModEventBus().register(new LeghornHenRenderer.ModelRegisterHandler());
	...
	public void initElements() {
		...
		elements.items.add(() -> new SpawnEggItem(entity, -2896957, -4974311, new Item.Properties().group(WildFarmCraftSpawnEggsItemGroup.tab))
				.setRegistryName("leghorn_hen_spawn_egg"));
	}
	...
	public static class CustomEntity extends TameableEntity {
		...
		public void baseTick() {
			...
			Entity entity = this;
			{
				...
				LeghornHenTickUpdateProcedure.executeProcedure($_dependencies);
			}
		}
