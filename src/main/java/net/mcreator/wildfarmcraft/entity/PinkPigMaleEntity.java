...
import net.mcreator.wildfarmcraft.procedures.PinkPigMaleTickUpdateProcedure;
...
import net.mcreator.wildfarmcraft.entity.renderer.PinkPigMaleRenderer;
...
public class PinkPigMaleEntity extends WildfarmcraftModElements.ModElement {
	public static EntityType entity = (EntityType.Builder.<CustomEntity>create(CustomEntity::new, EntityClassification.CREATURE)
			.setShouldReceiveVelocityUpdates(true).setTrackingRange(64).setUpdateInterval(3).setCustomClientFactory(CustomEntity::new)
			.size(0.9f, 1.0999999999999999f)).build("pink_pig_male").setRegistryName("pink_pig_male");
	public PinkPigMaleEntity(WildfarmcraftModElements instance) {
		super(instance, 9);
		FMLJavaModLoadingContext.get().getModEventBus().register(new PinkPigMaleRenderer.ModelRegisterHandler());
	...
	public void initElements() {
		...
		elements.items.add(() -> new SpawnEggItem(entity, -2586237, -2586237, new Item.Properties().group(WildFarmCraftSpawnEggsItemGroup.tab))
				.setRegistryName("pink_pig_male_spawn_egg"));
	}
	...
	public static class CustomEntity extends TameableEntity {
		...
		public void baseTick() {
			...
			Entity entity = this;
			{
				...
				PinkPigMaleTickUpdateProcedure.executeProcedure($_dependencies);
			}
		}
