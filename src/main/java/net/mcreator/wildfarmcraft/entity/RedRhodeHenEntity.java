...
import net.mcreator.wildfarmcraft.procedures.RedRhodeHenTickUpdateProcedure;
...
import net.mcreator.wildfarmcraft.entity.renderer.RedRhodeHenRenderer;
...
public class RedRhodeHenEntity extends WildfarmcraftModElements.ModElement {
	public static EntityType entity = (EntityType.Builder.<CustomEntity>create(CustomEntity::new, EntityClassification.CREATURE)
			.setShouldReceiveVelocityUpdates(true).setTrackingRange(64).setUpdateInterval(3).setCustomClientFactory(CustomEntity::new)
			.size(0.5f, 0.7f)).build("red_rhode_hen").setRegistryName("red_rhode_hen");
	public RedRhodeHenEntity(WildfarmcraftModElements instance) {
		super(instance, 395);
		FMLJavaModLoadingContext.get().getModEventBus().register(new RedRhodeHenRenderer.ModelRegisterHandler());
	...
	public void initElements() {
		...
		elements.items.add(() -> new SpawnEggItem(entity, -11851234, -4974311, new Item.Properties().group(WildFarmCraftSpawnEggsItemGroup.tab))
				.setRegistryName("red_rhode_hen_spawn_egg"));
	}
	...
	public static class CustomEntity extends TameableEntity {
		...
		public void baseTick() {
			...
			Entity entity = this;
			{
				...
				RedRhodeHenTickUpdateProcedure.executeProcedure($_dependencies);
			}
		}
