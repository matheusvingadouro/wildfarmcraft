...
import net.mcreator.wildfarmcraft.procedures.IberianCowTickUpdateProcedure;
...
import net.mcreator.wildfarmcraft.entity.renderer.IberianCowRenderer;
...
public class IberianCowEntity extends WildfarmcraftModElements.ModElement {
	public static EntityType entity = (EntityType.Builder.<CustomEntity>create(CustomEntity::new, EntityClassification.CREATURE)
			.setShouldReceiveVelocityUpdates(true).setTrackingRange(64).setUpdateInterval(3).setCustomClientFactory(CustomEntity::new)
			.size(0.9f, 1.6f)).build("iberian_cow").setRegistryName("iberian_cow");
	public IberianCowEntity(WildfarmcraftModElements instance) {
		super(instance, 129);
		FMLJavaModLoadingContext.get().getModEventBus().register(new IberianCowRenderer.ModelRegisterHandler());
	...
	public void initElements() {
		...
		elements.items.add(() -> new SpawnEggItem(entity, -14869219, -14869219, new Item.Properties().group(WildFarmCraftSpawnEggsItemGroup.tab))
				.setRegistryName("iberian_cow_spawn_egg"));
	}
	...
	public static class CustomEntity extends TameableEntity {
		...
		public void baseTick() {
			...
			Entity entity = this;
			{
				...
				IberianCowTickUpdateProcedure.executeProcedure($_dependencies);
			}
		}
