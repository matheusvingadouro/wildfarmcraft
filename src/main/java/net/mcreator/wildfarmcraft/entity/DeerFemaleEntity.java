...
import net.mcreator.wildfarmcraft.procedures.DeerFemaleTickUpdateProcedure;
...
import net.mcreator.wildfarmcraft.entity.renderer.DeerFemaleRenderer;
...
public class DeerFemaleEntity extends WildfarmcraftModElements.ModElement {
	...
	public void initElements() {
		...
		elements.items.add(() -> new SpawnEggItem(entity, -7050688, -4222105, new Item.Properties().group(WildFarmCraftSpawnEggsItemGroup.tab))
				.setRegistryName("deer_female_spawn_egg"));
	}
	...
	public static class CustomEntity extends TameableEntity {
		...
		public void baseTick() {
			...
			Entity entity = this;
			{
				...
				DeerFemaleTickUpdateProcedure.executeProcedure($_dependencies);
			}
		}
