...
import net.mcreator.wildfarmcraft.procedures.HighlandsBullTickUpdateProcedure;
...
import net.mcreator.wildfarmcraft.entity.renderer.HighlandsBullRenderer;
...
public class HighlandsBullEntity extends WildfarmcraftModElements.ModElement {
	public static EntityType entity = (EntityType.Builder.<CustomEntity>create(CustomEntity::new, EntityClassification.CREATURE)
			.setShouldReceiveVelocityUpdates(true).setTrackingRange(64).setUpdateInterval(3).setCustomClientFactory(CustomEntity::new)
			.size(0.9f, 1.6f)).build("highlands_bull").setRegistryName("highlands_bull");
	public HighlandsBullEntity(WildfarmcraftModElements instance) {
		super(instance, 359);
		FMLJavaModLoadingContext.get().getModEventBus().register(new HighlandsBullRenderer.ModelRegisterHandler());
	...
	public void initElements() {
		...
		elements.items.add(() -> new SpawnEggItem(entity, -8957136, -6984381, new Item.Properties().group(WildFarmCraftSpawnEggsItemGroup.tab))
				.setRegistryName("highlands_bull_spawn_egg"));
	}
	...
	public static class CustomEntity extends TameableEntity {
		...
		public void baseTick() {
			...
			Entity entity = this;
			{
				...
				HighlandsBullTickUpdateProcedure.executeProcedure($_dependencies);
			}
		}
