...
import net.mcreator.wildfarmcraft.procedures.GirCowTickUpdateProcedure;
...
import net.mcreator.wildfarmcraft.entity.renderer.GirCowRenderer;
...
public class GirCowEntity extends WildfarmcraftModElements.ModElement {
	public static EntityType entity = (EntityType.Builder.<CustomEntity>create(CustomEntity::new, EntityClassification.CREATURE)
			.setShouldReceiveVelocityUpdates(true).setTrackingRange(64).setUpdateInterval(3).setCustomClientFactory(CustomEntity::new)
			.size(0.9f, 1.6f)).build("gir_cow").setRegistryName("gir_cow");
	public GirCowEntity(WildfarmcraftModElements instance) {
		super(instance, 352);
		FMLJavaModLoadingContext.get().getModEventBus().register(new GirCowRenderer.ModelRegisterHandler());
	...
	public void initElements() {
		...
		elements.items.add(() -> new SpawnEggItem(entity, -10535904, -2897215, new Item.Properties().group(WildFarmCraftSpawnEggsItemGroup.tab))
				.setRegistryName("gir_cow_spawn_egg"));
	}
	...
	public static class CustomEntity extends TameableEntity {
		...
		public void baseTick() {
			...
			Entity entity = this;
			{
				...
				GirCowTickUpdateProcedure.executeProcedure($_dependencies);
			}
		}
