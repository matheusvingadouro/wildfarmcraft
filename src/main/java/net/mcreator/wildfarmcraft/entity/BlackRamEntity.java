...
import net.mcreator.wildfarmcraft.procedures.BlackRamTickUpdateProcedure;
...
import net.mcreator.wildfarmcraft.entity.renderer.BlackRamRenderer;
...
public class BlackRamEntity extends WildfarmcraftModElements.ModElement {
	public static EntityType entity = (EntityType.Builder.<CustomEntity>create(CustomEntity::new, EntityClassification.CREATURE)
			.setShouldReceiveVelocityUpdates(true).setTrackingRange(64).setUpdateInterval(3).setCustomClientFactory(CustomEntity::new)
			.size(0.9f, 1.2f)).build("black_ram").setRegistryName("black_ram");
	public BlackRamEntity(WildfarmcraftModElements instance) {
		super(instance, 160);
		FMLJavaModLoadingContext.get().getModEventBus().register(new BlackRamRenderer.ModelRegisterHandler());
	...
	public void initElements() {
		...
		elements.items.add(() -> new SpawnEggItem(entity, -14671840, -14671840, new Item.Properties().group(WildFarmCraftSpawnEggsItemGroup.tab))
				.setRegistryName("black_ram_spawn_egg"));
	}
	...
	public static class CustomEntity extends TameableEntity {
		...
		public void baseTick() {
			...
			Entity entity = this;
			{
				...
				BlackRamTickUpdateProcedure.executeProcedure($_dependencies);
			}
		}
