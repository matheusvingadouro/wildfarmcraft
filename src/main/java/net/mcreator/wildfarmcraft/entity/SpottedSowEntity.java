...
import net.mcreator.wildfarmcraft.procedures.SpottedSowTickUpdateProcedure;
...
import net.mcreator.wildfarmcraft.entity.renderer.SpottedSowRenderer;
...
public class SpottedSowEntity extends WildfarmcraftModElements.ModElement {
	public static EntityType entity = (EntityType.Builder.<CustomEntity>create(CustomEntity::new, EntityClassification.CREATURE)
			.setShouldReceiveVelocityUpdates(true).setTrackingRange(64).setUpdateInterval(3).setCustomClientFactory(CustomEntity::new)
			.size(0.9f, 1.0999999999999999f)).build("spotted_sow").setRegistryName("spotted_sow");
	public SpottedSowEntity(WildfarmcraftModElements instance) {
		super(instance, 401);
		FMLJavaModLoadingContext.get().getModEventBus().register(new SpottedSowRenderer.ModelRegisterHandler());
	...
	public static class CustomEntity extends TameableEntity {
		...
		public void baseTick() {
			...
			Entity entity = this;
			{
				...
				SpottedSowTickUpdateProcedure.executeProcedure($_dependencies);
			}
		}
