...
import net.mcreator.wildfarmcraft.procedures.HighlandsCowTickUpdateProcedure;
...
import net.mcreator.wildfarmcraft.entity.renderer.HighlandsCowRenderer;
...
public class HighlandsCowEntity extends WildfarmcraftModElements.ModElement {
	public static EntityType entity = (EntityType.Builder.<CustomEntity>create(CustomEntity::new, EntityClassification.CREATURE)
			.setShouldReceiveVelocityUpdates(true).setTrackingRange(64).setUpdateInterval(3).setCustomClientFactory(CustomEntity::new)
			.size(0.9f, 1.6f)).build("highlands_cow").setRegistryName("highlands_cow");
	public HighlandsCowEntity(WildfarmcraftModElements instance) {
		super(instance, 358);
		FMLJavaModLoadingContext.get().getModEventBus().register(new HighlandsCowRenderer.ModelRegisterHandler());
	...
	public void initElements() {
		...
		elements.items.add(() -> new SpawnEggItem(entity, -8957136, -6984381, new Item.Properties().group(WildFarmCraftSpawnEggsItemGroup.tab))
				.setRegistryName("highlands_cow_spawn_egg"));
	}
	...
	public static class CustomEntity extends TameableEntity {
		...
		public void baseTick() {
			...
			Entity entity = this;
			{
				...
				HighlandsCowTickUpdateProcedure.executeProcedure($_dependencies);
			}
		}
