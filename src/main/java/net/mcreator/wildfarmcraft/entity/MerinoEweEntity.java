...
import net.mcreator.wildfarmcraft.procedures.MerinoEweTickUpdateProcedure;
...
import net.mcreator.wildfarmcraft.entity.renderer.MerinoEweRenderer;
...
public class MerinoEweEntity extends WildfarmcraftModElements.ModElement {
	public static EntityType entity = (EntityType.Builder.<CustomEntity>create(CustomEntity::new, EntityClassification.CREATURE)
			.setShouldReceiveVelocityUpdates(true).setTrackingRange(64).setUpdateInterval(3).setCustomClientFactory(CustomEntity::new)
			.size(0.9f, 1.2f)).build("merino_ewe").setRegistryName("merino_ewe");
	public MerinoEweEntity(WildfarmcraftModElements instance) {
		super(instance, 167);
		FMLJavaModLoadingContext.get().getModEventBus().register(new MerinoEweRenderer.ModelRegisterHandler());
	...
	public void initElements() {
		...
		elements.items.add(() -> new SpawnEggItem(entity, -2041132, -4148313, new Item.Properties().group(WildFarmCraftSpawnEggsItemGroup.tab))
				.setRegistryName("merino_ewe_spawn_egg"));
	}
	...
	public static class CustomEntity extends TameableEntity {
		...
		public void baseTick() {
			...
			Entity entity = this;
			{
				...
				MerinoEweTickUpdateProcedure.executeProcedure($_dependencies);
			}
		}
