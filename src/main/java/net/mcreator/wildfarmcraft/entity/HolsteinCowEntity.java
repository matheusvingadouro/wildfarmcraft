...
import net.mcreator.wildfarmcraft.procedures.HolsteinCowOnEntityTickUpdateProcedure;
...
import net.mcreator.wildfarmcraft.entity.renderer.HolsteinCowRenderer;
...
public class HolsteinCowEntity extends WildfarmcraftModElements.ModElement {
	public static EntityType entity = (EntityType.Builder.<CustomEntity>create(CustomEntity::new, EntityClassification.CREATURE)
			.setShouldReceiveVelocityUpdates(true).setTrackingRange(64).setUpdateInterval(3).setCustomClientFactory(CustomEntity::new)
			.size(0.9f, 1.6f)).build("holstein_cow").setRegistryName("holstein_cow");
	public HolsteinCowEntity(WildfarmcraftModElements instance) {
		super(instance, 2);
		FMLJavaModLoadingContext.get().getModEventBus().register(new HolsteinCowRenderer.ModelRegisterHandler());
	...
	public void initElements() {
		...
		elements.items.add(() -> new SpawnEggItem(entity, -2897215, -14869219, new Item.Properties().group(WildFarmCraftSpawnEggsItemGroup.tab))
				.setRegistryName("holstein_cow_spawn_egg"));
	}
	...
	public static class CustomEntity extends TameableEntity {
		...
		public void baseTick() {
			...
			Entity entity = this;
			{
				...
				HolsteinCowOnEntityTickUpdateProcedure.executeProcedure($_dependencies);
			}
		}
