...
import net.mcreator.wildfarmcraft.procedures.MerinoRamTickUpdateProcedure;
...
import net.mcreator.wildfarmcraft.entity.renderer.MerinoRamRenderer;
...
public class MerinoRamEntity extends WildfarmcraftModElements.ModElement {
	public static EntityType entity = (EntityType.Builder.<CustomEntity>create(CustomEntity::new, EntityClassification.CREATURE)
			.setShouldReceiveVelocityUpdates(true).setTrackingRange(64).setUpdateInterval(3).setCustomClientFactory(CustomEntity::new)
			.size(0.9f, 1.2f)).build("merino_ram").setRegistryName("merino_ram");
	public MerinoRamEntity(WildfarmcraftModElements instance) {
		super(instance, 168);
		FMLJavaModLoadingContext.get().getModEventBus().register(new MerinoRamRenderer.ModelRegisterHandler());
	...
	public void initElements() {
		...
		elements.items.add(() -> new SpawnEggItem(entity, -2041132, -4148313, new Item.Properties().group(WildFarmCraftSpawnEggsItemGroup.tab))
				.setRegistryName("merino_ram_spawn_egg"));
	}
	...
	public static class CustomEntity extends TameableEntity {
		...
		public void baseTick() {
			...
			Entity entity = this;
			{
				...
				MerinoRamTickUpdateProcedure.executeProcedure($_dependencies);
			}
		}
