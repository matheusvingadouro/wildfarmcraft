...
import net.mcreator.wildfarmcraft.procedures.AurochsSpawnCondiProcedure;
import net.mcreator.wildfarmcraft.procedures.AurochsBullTickUpdateProcedure;
...
import net.mcreator.wildfarmcraft.entity.renderer.AurochsBullRenderer;
...
public class AurochsBullEntity extends WildfarmcraftModElements.ModElement {
	public static EntityType entity = (EntityType.Builder.<CustomEntity>create(CustomEntity::new, EntityClassification.CREATURE)
			.setShouldReceiveVelocityUpdates(true).setTrackingRange(64).setUpdateInterval(3).setCustomClientFactory(CustomEntity::new)
			.size(1.2000000000000002f, 1.7000000000000002f)).build("aurochs_bull").setRegistryName("aurochs_bull");
	public AurochsBullEntity(WildfarmcraftModElements instance) {
		super(instance, 109);
		FMLJavaModLoadingContext.get().getModEventBus().register(new AurochsBullRenderer.ModelRegisterHandler());
	...
	public void initElements() {
		...
		elements.items.add(() -> new SpawnEggItem(entity, -14213868, -8695767, new Item.Properties().group(WildFarmCraftSpawnEggsItemGroup.tab))
				.setRegistryName("aurochs_bull_spawn_egg"));
	}
	...
	public void init(FMLCommonSetupEvent event) {
		EntitySpawnPlacementRegistry.register(entity, EntitySpawnPlacementRegistry.PlacementType.ON_GROUND, Heightmap.Type.MOTION_BLOCKING_NO_LEAVES,
				(entityType, world, reason, pos, random) -> {
					...
					int y = pos.getY();
					int z = pos.getZ();
					return AurochsSpawnCondiProcedure.executeProcedure(ImmutableMap.of("x", x, "y", y, "z", z, "world", world));
				});
	}
	...
	public static class CustomEntity extends TameableEntity {
		...
		public void baseTick() {
			...
			Entity entity = this;
			{
				...
				AurochsBullTickUpdateProcedure.executeProcedure($_dependencies);
			}
		}
