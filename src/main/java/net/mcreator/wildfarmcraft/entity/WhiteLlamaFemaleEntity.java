...
import net.mcreator.wildfarmcraft.procedures.WhiteLlamaFemaleTickUpdateProcedure;
...
import net.mcreator.wildfarmcraft.entity.renderer.WhiteLlamaFemaleRenderer;
...
public class WhiteLlamaFemaleEntity extends WildfarmcraftModElements.ModElement {
	public static EntityType entity = (EntityType.Builder.<CustomEntity>create(CustomEntity::new, EntityClassification.CREATURE)
			.setShouldReceiveVelocityUpdates(true).setTrackingRange(64).setUpdateInterval(3).setCustomClientFactory(CustomEntity::new)
			.size(0.9f, 1.8f)).build("white_llama_female").setRegistryName("white_llama_female");
	public WhiteLlamaFemaleEntity(WildfarmcraftModElements instance) {
		super(instance, 477);
		FMLJavaModLoadingContext.get().getModEventBus().register(new WhiteLlamaFemaleRenderer.ModelRegisterHandler());
	...
	public void initElements() {
		...
		elements.items.add(() -> new SpawnEggItem(entity, -3094594, -2436406, new Item.Properties().group(WildFarmCraftSpawnEggsItemGroup.tab))
				.setRegistryName("white_llama_female_spawn_egg"));
	}
	...
	public static class CustomEntity extends TameableEntity {
		...
		protected void registerGoals() {
			...
			this.goalSelector.addGoal(11, new WaterAvoidingRandomWalkingGoal(this, 1));
		...
		public void baseTick() {
			...
			Entity entity = this;
			{
				...
				WhiteLlamaFemaleTickUpdateProcedure.executeProcedure($_dependencies);
			}
		}
