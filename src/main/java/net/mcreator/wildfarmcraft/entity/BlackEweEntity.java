...
import net.mcreator.wildfarmcraft.procedures.BlackEweTickUpdateProcedure;
...
import net.mcreator.wildfarmcraft.entity.renderer.BlackEweRenderer;
...
public class BlackEweEntity extends WildfarmcraftModElements.ModElement {
	public static EntityType entity = (EntityType.Builder.<CustomEntity>create(CustomEntity::new, EntityClassification.CREATURE)
			.setShouldReceiveVelocityUpdates(true).setTrackingRange(64).setUpdateInterval(3).setCustomClientFactory(CustomEntity::new)
			.size(0.9f, 1.2f)).build("black_ewe").setRegistryName("black_ewe");
	public BlackEweEntity(WildfarmcraftModElements instance) {
		super(instance, 159);
		FMLJavaModLoadingContext.get().getModEventBus().register(new BlackEweRenderer.ModelRegisterHandler());
	...
	public void initElements() {
		...
		elements.items.add(() -> new SpawnEggItem(entity, -14671840, -14671840, new Item.Properties().group(WildFarmCraftSpawnEggsItemGroup.tab))
				.setRegistryName("black_ewe_spawn_egg"));
	}
	...
	public static class CustomEntity extends TameableEntity {
		...
		public void baseTick() {
			...
			Entity entity = this;
			{
				...
				BlackEweTickUpdateProcedure.executeProcedure($_dependencies);
			}
		}
