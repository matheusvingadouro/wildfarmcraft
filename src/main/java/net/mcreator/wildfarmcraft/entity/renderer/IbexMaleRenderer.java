...
@OnlyIn(Dist.CLIENT)
public class IbexMaleRenderer {
	public static class ModelRegisterHandler {
		@SubscribeEvent
		@OnlyIn(Dist.CLIENT)
		public void registerModels(ModelRegistryEvent event) {
			RenderingRegistry.registerEntityRenderingHandler(IbexMaleEntity.entity, renderManager -> {
				return new MobRenderer(renderManager, new ModelIbexMale(), 0.7f) {
					@Override
					public ResourceLocation getEntityTexture(Entity entity) {
						return new ResourceLocation("wildfarmcraft:textures/ibexmale.png");
					}
				};
			});
		}
	 ...
	 */
	public static class ModelIbexMale extends EntityModel<Entity> {
