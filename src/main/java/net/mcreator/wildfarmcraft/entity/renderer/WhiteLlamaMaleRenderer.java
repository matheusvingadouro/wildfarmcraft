...
@OnlyIn(Dist.CLIENT)
public class WhiteLlamaMaleRenderer {
	public static class ModelRegisterHandler {
		@SubscribeEvent
		@OnlyIn(Dist.CLIENT)
		public void registerModels(ModelRegistryEvent event) {
			RenderingRegistry.registerEntityRenderingHandler(WhiteLlamaMaleEntity.entity, renderManager -> {
				return new MobRenderer(renderManager, new ModelLlamaMale(), 0.7f) {
					@Override
					public ResourceLocation getEntityTexture(Entity entity) {
						return new ResourceLocation("wildfarmcraft:textures/llamamale.png");
					}
				};
			});
		}
	...
	/**
	 * LlamaMale - Matheus Created using Tabula 7.1.0
	 */
	public static class ModelLlamaMale extends EntityModel<Entity> {
		...
		public ModelLlamaMale() {
			...
			this.BodyWool.addBox(0.0F, 0.0F, 0.0F, 9, 11, 20, 0.0F);
