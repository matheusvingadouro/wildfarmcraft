...
@OnlyIn(Dist.CLIENT)
public class DomesticTurkeyMaleRenderer {
	public static class ModelRegisterHandler {
		@SubscribeEvent
		@OnlyIn(Dist.CLIENT)
		public void registerModels(ModelRegistryEvent event) {
			RenderingRegistry.registerEntityRenderingHandler(DomesticTurkeyMaleEntity.entity, renderManager -> {
				return new MobRenderer(renderManager, new ModelTurkeyDomesticMale(), 0.4f) {
					@Override
					public ResourceLocation getEntityTexture(Entity entity) {
						return new ResourceLocation("wildfarmcraft:textures/turkeydomesticmale.png");
					}
				};
			});
		}
	 ...
	 */
	public static class ModelTurkeyDomesticMale extends EntityModel<Entity> {
