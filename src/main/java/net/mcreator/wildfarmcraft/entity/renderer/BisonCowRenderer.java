...
@OnlyIn(Dist.CLIENT)
public class BisonCowRenderer {
	public static class ModelRegisterHandler {
		@SubscribeEvent
		@OnlyIn(Dist.CLIENT)
		public void registerModels(ModelRegistryEvent event) {
			RenderingRegistry.registerEntityRenderingHandler(BisonCowEntity.entity, renderManager -> {
				return new MobRenderer(renderManager, new ModelBisonFemale(), 0.9f) {
					@Override
					public ResourceLocation getEntityTexture(Entity entity) {
						return new ResourceLocation("wildfarmcraft:textures/bisonfemale.png");
					}
				};
			});
		}
	 ...
	 */
	public static class ModelBisonFemale extends EntityModel<Entity> {
