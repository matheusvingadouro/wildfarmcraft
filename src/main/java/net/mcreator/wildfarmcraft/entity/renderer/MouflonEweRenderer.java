...
@OnlyIn(Dist.CLIENT)
public class MouflonEweRenderer {
	public static class ModelRegisterHandler {
		@SubscribeEvent
		@OnlyIn(Dist.CLIENT)
		public void registerModels(ModelRegistryEvent event) {
			RenderingRegistry.registerEntityRenderingHandler(MouflonEweEntity.entity, renderManager -> {
				return new MobRenderer(renderManager, new ModelMouflonEwe(), 0.7000000000000001f) {
					@Override
					public ResourceLocation getEntityTexture(Entity entity) {
						return new ResourceLocation("wildfarmcraft:textures/mouflonewe.png");
					}
				};
			});
		}
	...
	/**
	 * MouflonEwe - Matheus Created using Tabula 7.1.0
	 */
	public static class ModelMouflonEwe extends EntityModel<Entity> {
		...
		public ModelMouflonEwe() {
			...
			this.LeftHorn1.setRotationPoint(1.4F, 0.2F, -4.9F);
			...
			this.RightHorn1.setRotationPoint(-2.0F, 0.6F, -4.0F);
