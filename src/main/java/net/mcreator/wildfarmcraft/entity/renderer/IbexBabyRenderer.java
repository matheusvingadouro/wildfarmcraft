...
@OnlyIn(Dist.CLIENT)
public class IbexBabyRenderer {
	public static class ModelRegisterHandler {
		@SubscribeEvent
		@OnlyIn(Dist.CLIENT)
		public void registerModels(ModelRegistryEvent event) {
			RenderingRegistry.registerEntityRenderingHandler(IbexBabyEntity.entity, renderManager -> {
				return new MobRenderer(renderManager, new ModelIbexBaby(), 0.6f) {
					@Override
					public ResourceLocation getEntityTexture(Entity entity) {
						return new ResourceLocation("wildfarmcraft:textures/ibexbaby.png");
					}
				};
			});
		}
