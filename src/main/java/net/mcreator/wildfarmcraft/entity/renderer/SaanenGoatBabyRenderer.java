...
@OnlyIn(Dist.CLIENT)
public class SaanenGoatBabyRenderer {
	public static class ModelRegisterHandler {
		@SubscribeEvent
		@OnlyIn(Dist.CLIENT)
		public void registerModels(ModelRegistryEvent event) {
			RenderingRegistry.registerEntityRenderingHandler(SaanenGoatBabyEntity.entity, renderManager -> {
				return new MobRenderer(renderManager, new ModelIbexBaby(), 0.6f) {
					@Override
					public ResourceLocation getEntityTexture(Entity entity) {
						return new ResourceLocation("wildfarmcraft:textures/saanengoatbaby.png");
					}
				};
			});
		}
	...
	/**
	 * IbexBaby - Matheus Created using Tabula 7.1.0
	 */
	public static class ModelIbexBaby extends EntityModel<Entity> {
