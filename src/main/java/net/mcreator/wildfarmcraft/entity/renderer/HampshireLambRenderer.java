...
@OnlyIn(Dist.CLIENT)
public class HampshireLambRenderer {
	public static class ModelRegisterHandler {
		@SubscribeEvent
		@OnlyIn(Dist.CLIENT)
		public void registerModels(ModelRegistryEvent event) {
			RenderingRegistry.registerEntityRenderingHandler(HampshireLambEntity.entity, renderManager -> {
				return new MobRenderer(renderManager, new ModelHampshireLamb(), 0.6f) {
					@Override
					public ResourceLocation getEntityTexture(Entity entity) {
						return new ResourceLocation("wildfarmcraft:textures/hampshirelamb.png");
					}
				};
			});
		}
