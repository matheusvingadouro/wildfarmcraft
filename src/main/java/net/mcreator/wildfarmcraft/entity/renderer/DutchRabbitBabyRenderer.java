...
@OnlyIn(Dist.CLIENT)
public class DutchRabbitBabyRenderer {
	public static class ModelRegisterHandler {
		@SubscribeEvent
		@OnlyIn(Dist.CLIENT)
		public void registerModels(ModelRegistryEvent event) {
			RenderingRegistry.registerEntityRenderingHandler(DutchRabbitBabyEntity.entity, renderManager -> {
				return new MobRenderer(renderManager, new ModelRabbitBaby(), 0.35f) {
					@Override
					public ResourceLocation getEntityTexture(Entity entity) {
						return new ResourceLocation("wildfarmcraft:textures/rabbitbaby.png");
					}
				};
			});
		}
