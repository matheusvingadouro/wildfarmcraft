...
@OnlyIn(Dist.CLIENT)
public class RedNubianGoatBabyRenderer {
	public static class ModelRegisterHandler {
		@SubscribeEvent
		@OnlyIn(Dist.CLIENT)
		public void registerModels(ModelRegistryEvent event) {
			RenderingRegistry.registerEntityRenderingHandler(RedNubianGoatBabyEntity.entity, renderManager -> {
				return new MobRenderer(renderManager, new ModelRedDairyGoatBaby(), 0.6f) {
					@Override
					public ResourceLocation getEntityTexture(Entity entity) {
						return new ResourceLocation("wildfarmcraft:textures/reddairygoatbaby.png");
					}
				};
			});
		}
	 ...
	 */
	public static class ModelRedDairyGoatBaby extends EntityModel<Entity> {
