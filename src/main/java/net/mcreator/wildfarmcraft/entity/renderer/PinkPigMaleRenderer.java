...
@OnlyIn(Dist.CLIENT)
public class PinkPigMaleRenderer {
	public static class ModelRegisterHandler {
		@SubscribeEvent
		@OnlyIn(Dist.CLIENT)
		public void registerModels(ModelRegistryEvent event) {
			RenderingRegistry.registerEntityRenderingHandler(PinkPigMaleEntity.entity, renderManager -> {
				return new MobRenderer(renderManager, new ModelPigMale(), 0.7f) {
					@Override
					public ResourceLocation getEntityTexture(Entity entity) {
						return new ResourceLocation("wildfarmcraft:textures/pigmale.png");
					}
				};
			});
		}
