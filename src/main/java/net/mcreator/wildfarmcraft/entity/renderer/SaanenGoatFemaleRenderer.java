...
@OnlyIn(Dist.CLIENT)
public class SaanenGoatFemaleRenderer {
	public static class ModelRegisterHandler {
		@SubscribeEvent
		@OnlyIn(Dist.CLIENT)
		public void registerModels(ModelRegistryEvent event) {
			RenderingRegistry.registerEntityRenderingHandler(SaanenGoatFemaleEntity.entity, renderManager -> {
				return new MobRenderer(renderManager, new ModelSaanenGoatFemale(), 0.7000000000000001f) {
					@Override
					public ResourceLocation getEntityTexture(Entity entity) {
						return new ResourceLocation("wildfarmcraft:textures/saanengoatfemale.png");
					}
				};
			});
		}
	...
	/**
	 * SaanenGoatFemale - Matheus Created using Tabula 7.1.0
	 */
	public static class ModelSaanenGoatFemale extends EntityModel<Entity> {
