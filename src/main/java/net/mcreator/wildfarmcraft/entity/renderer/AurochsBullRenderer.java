...
@OnlyIn(Dist.CLIENT)
public class AurochsBullRenderer {
	public static class ModelRegisterHandler {
		@SubscribeEvent
		@OnlyIn(Dist.CLIENT)
		public void registerModels(ModelRegistryEvent event) {
			RenderingRegistry.registerEntityRenderingHandler(AurochsBullEntity.entity, renderManager -> {
				return new MobRenderer(renderManager, new ModelAurochsBull(), 0.9f) {
					@Override
					public ResourceLocation getEntityTexture(Entity entity) {
						return new ResourceLocation("wildfarmcraft:textures/aurochsbull.png");
					}
				};
			});
		}
	 ...
	 */
	public static class ModelAurochsBull extends EntityModel<Entity> {
