...
@OnlyIn(Dist.CLIENT)
public class WhiteLlamaFemaleRenderer {
	public static class ModelRegisterHandler {
		@SubscribeEvent
		@OnlyIn(Dist.CLIENT)
		public void registerModels(ModelRegistryEvent event) {
			RenderingRegistry.registerEntityRenderingHandler(WhiteLlamaFemaleEntity.entity, renderManager -> {
				return new MobRenderer(renderManager, new ModelLlamaFemale(), 0.7000000000000001f) {
					@Override
					public ResourceLocation getEntityTexture(Entity entity) {
						return new ResourceLocation("wildfarmcraft:textures/llamafemale.png");
					}
				};
			});
		}
	...
	/**
	 * LlamaFemale - Matheus Created using Tabula 7.1.0
	 */
	public static class ModelLlamaFemale extends EntityModel<Entity> {
		...
		public ModelLlamaFemale() {
			...
			this.BodyWool = new ModelRenderer(this, 28, 95);
			this.BodyWool.setRotationPoint(-0.5F, -0.5F, -0.5F);
			this.BodyWool.addBox(0.0F, 0.0F, 0.0F, 9, 10, 20, 0.0F);
			...
			this.udders.setRotationPoint(2.0F, 7.0F, 13.0F);
			...
			this.setRotateAngle(Neck, -1.186823891356144F, 0.0F, 0.0F);
