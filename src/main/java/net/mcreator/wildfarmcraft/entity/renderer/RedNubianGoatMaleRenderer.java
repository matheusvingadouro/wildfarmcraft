...
@OnlyIn(Dist.CLIENT)
public class RedNubianGoatMaleRenderer {
	public static class ModelRegisterHandler {
		@SubscribeEvent
		@OnlyIn(Dist.CLIENT)
		public void registerModels(ModelRegistryEvent event) {
			RenderingRegistry.registerEntityRenderingHandler(RedNubianGoatMaleEntity.entity, renderManager -> {
				return new MobRenderer(renderManager, new ModelRedDairyGoatMale(), 0.7f) {
					@Override
					public ResourceLocation getEntityTexture(Entity entity) {
						return new ResourceLocation("wildfarmcraft:textures/reddairygoatmale.png");
					}
				};
			});
		}
	...
	/**
	 * RedDairyGoatMale - Matheus Created using Tabula 7.1.0
	 */
	public static class ModelRedDairyGoatMale extends EntityModel<Entity> {
		...
		public ModelRedDairyGoatMale() {
			this.textureWidth = 128;
			this.textureHeight = 128;
			this.LeftHorn1 = new ModelRenderer(this, 0, 34);
			this.LeftHorn1.setRotationPoint(1.1F, -0.6F, -3.5F);
			this.LeftHorn1.addBox(-3.0F, -1.0F, -1.0F, 5, 2, 2, 0.0F);
			this.setRotateAngle(LeftHorn1, 0.0F, 2.6179938779914944F, -1.2217304763960306F);
			...
			this.LeftHorn3.setRotationPoint(-2.8F, 0.8F, -0.05F);
			this.LeftHorn3.addBox(0.0F, -0.5F, -0.5F, 3, 1, 1, 0.0F);
			this.setRotateAngle(LeftHorn3, 0.0F, 0.0F, 2.530727415391778F);
			...
			this.RightHorn1.setRotationPoint(-2.1F, -0.7F, -3.5F);
			this.RightHorn1.addBox(-3.0F, -1.0F, -1.0F, 5, 2, 2, 0.0F);
			this.setRotateAngle(RightHorn1, 0.0F, 0.5235987755982988F, 1.2217304763960306F);
			...
			this.LeftHorn2.setRotationPoint(-2.0F, -1.2F, 0.1F);
			this.LeftHorn2.addBox(-3.0F, 0.0F, -0.5F, 2, 2, 1, 0.0F);
			this.setRotateAngle(LeftHorn2, 0.0F, -0.2617993877991494F, -0.3490658503988659F);
			...
			this.RightHorn3.setRotationPoint(-2.6F, 0.6F, 0.05F);
			this.RightHorn3.addBox(0.0F, -0.5F, -0.5F, 3, 1, 1, 0.0F);
			this.setRotateAngle(RightHorn3, 0.0F, 0.0F, 2.530727415391778F);
			...
			this.RightHorn2.setRotationPoint(-2.0F, -1.2F, -0.2F);
			this.RightHorn2.addBox(-3.0F, 0.0F, -0.5F, 2, 2, 1, 0.0F);
			this.setRotateAngle(RightHorn2, 0.0F, 0.2617993877991494F, -0.3490658503988659F);
			this.NeckWOOL = new ModelRenderer(this, 77, 80);
			this.NeckWOOL.setRotationPoint(-2.0F, -2.9F, -3.1F);
			this.NeckWOOL.addBox(0.0F, 0.0F, 0.0F, 3, 4, 9, 0.0F);
			this.setRotateAngle(NeckWOOL, -0.22689280275926282F, 0.0F, 0.0F);
