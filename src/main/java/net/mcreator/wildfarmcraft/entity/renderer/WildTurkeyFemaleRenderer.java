...
@OnlyIn(Dist.CLIENT)
public class WildTurkeyFemaleRenderer {
	public static class ModelRegisterHandler {
		@SubscribeEvent
		@OnlyIn(Dist.CLIENT)
		public void registerModels(ModelRegistryEvent event) {
			RenderingRegistry.registerEntityRenderingHandler(WildTurkeyFemaleEntity.entity, renderManager -> {
				return new MobRenderer(renderManager, new ModelTurkeyWildFemale(), 0.4f) {
					@Override
					public ResourceLocation getEntityTexture(Entity entity) {
						return new ResourceLocation("wildfarmcraft:textures/turkeywildfemale.png");
					}
				};
			});
		}
	 ...
	 */
	public static class ModelTurkeyWildFemale extends EntityModel<Entity> {
