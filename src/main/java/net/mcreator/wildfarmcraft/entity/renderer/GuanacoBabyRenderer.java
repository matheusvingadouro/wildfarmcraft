...
@OnlyIn(Dist.CLIENT)
public class GuanacoBabyRenderer {
	public static class ModelRegisterHandler {
		@SubscribeEvent
		@OnlyIn(Dist.CLIENT)
		public void registerModels(ModelRegistryEvent event) {
			RenderingRegistry.registerEntityRenderingHandler(GuanacoBabyEntity.entity, renderManager -> {
				return new MobRenderer(renderManager, new ModelLlamaBaby(), 0.6f) {
					@Override
					public ResourceLocation getEntityTexture(Entity entity) {
						return new ResourceLocation("wildfarmcraft:textures/guanacobaby.png");
					}
				};
			});
		}
