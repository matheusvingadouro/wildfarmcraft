...
@OnlyIn(Dist.CLIENT)
public class DeerFemaleRenderer {
	public static class ModelRegisterHandler {
		@SubscribeEvent
		@OnlyIn(Dist.CLIENT)
		public void registerModels(ModelRegistryEvent event) {
			RenderingRegistry.registerEntityRenderingHandler(DeerFemaleEntity.entity, renderManager -> {
				return new MobRenderer(renderManager, new ModelDeerFemale(), 0.7000000000000001f) {
					@Override
					public ResourceLocation getEntityTexture(Entity entity) {
						return new ResourceLocation("wildfarmcraft:textures/deerfemale.png");
					}
				};
			});
		}
	 ...
	 */
	public static class ModelDeerFemale extends EntityModel<Entity> {
