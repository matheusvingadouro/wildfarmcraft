...
@OnlyIn(Dist.CLIENT)
public class JunglefowlChickRenderer {
	public static class ModelRegisterHandler {
		@SubscribeEvent
		@OnlyIn(Dist.CLIENT)
		public void registerModels(ModelRegistryEvent event) {
			RenderingRegistry.registerEntityRenderingHandler(JunglefowlChickEntity.entity, renderManager -> {
				return new MobRenderer(renderManager, new ModelLeghornChick(), 0.35f) {
					@Override
					public ResourceLocation getEntityTexture(Entity entity) {
						return new ResourceLocation("wildfarmcraft:textures/junglefowlchick.png");
					}
				};
			});
		}
