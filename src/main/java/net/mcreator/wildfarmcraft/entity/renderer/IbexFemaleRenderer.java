...
@OnlyIn(Dist.CLIENT)
public class IbexFemaleRenderer {
	public static class ModelRegisterHandler {
		@SubscribeEvent
		@OnlyIn(Dist.CLIENT)
		public void registerModels(ModelRegistryEvent event) {
			RenderingRegistry.registerEntityRenderingHandler(IbexFemaleEntity.entity, renderManager -> {
				return new MobRenderer(renderManager, new ModelIbexFemale(), 0.7000000000000001f) {
					@Override
					public ResourceLocation getEntityTexture(Entity entity) {
						return new ResourceLocation("wildfarmcraft:textures/ibexfemale.png");
					}
				};
			});
		}
	...
	/**
	 * IbexFemale - Matheus Created using Tabula 7.1.0
	 */
	public static class ModelIbexFemale extends EntityModel<Entity> {
		...
		public ModelIbexFemale() {
			...
			this.udders.setRotationPoint(2.0F, 6.0F, 11.0F);
