...
@OnlyIn(Dist.CLIENT)
public class HighlandsCalfRenderer {
	public static class ModelRegisterHandler {
		@SubscribeEvent
		@OnlyIn(Dist.CLIENT)
		public void registerModels(ModelRegistryEvent event) {
			RenderingRegistry.registerEntityRenderingHandler(HighlandsCalfEntity.entity, renderManager -> {
				return new MobRenderer(renderManager, new ModelHighlandsCalf(), 0.9f) {
					@Override
					public ResourceLocation getEntityTexture(Entity entity) {
						return new ResourceLocation("wildfarmcraft:textures/highlandscalf.png");
					}
				};
			});
		}
	 ...
	 */
	public static class ModelHighlandsCalf extends EntityModel<Entity> {
