...
@OnlyIn(Dist.CLIENT)
public class GirCowRenderer {
	public static class ModelRegisterHandler {
		@SubscribeEvent
		@OnlyIn(Dist.CLIENT)
		public void registerModels(ModelRegistryEvent event) {
			RenderingRegistry.registerEntityRenderingHandler(GirCowEntity.entity, renderManager -> {
				return new MobRenderer(renderManager, new ModelGirCow(), 0.9f) {
					@Override
					public ResourceLocation getEntityTexture(Entity entity) {
						return new ResourceLocation("wildfarmcraft:textures/gircow.png");
					}
				};
			});
		}
	 ...
	 */
	public static class ModelGirCow extends EntityModel<Entity> {
