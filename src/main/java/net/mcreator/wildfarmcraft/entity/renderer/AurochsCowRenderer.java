...
@OnlyIn(Dist.CLIENT)
public class AurochsCowRenderer {
	public static class ModelRegisterHandler {
		@SubscribeEvent
		@OnlyIn(Dist.CLIENT)
		public void registerModels(ModelRegistryEvent event) {
			RenderingRegistry.registerEntityRenderingHandler(AurochsCowEntity.entity, renderManager -> {
				return new MobRenderer(renderManager, new ModelAurochsCow(), 0.9f) {
					@Override
					public ResourceLocation getEntityTexture(Entity entity) {
						return new ResourceLocation("wildfarmcraft:textures/aurochscow.png");
					}
				};
			});
		}
	 ...
	 */
	public static class ModelAurochsCow extends EntityModel<Entity> {
