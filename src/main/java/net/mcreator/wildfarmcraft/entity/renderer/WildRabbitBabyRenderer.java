...
@OnlyIn(Dist.CLIENT)
public class WildRabbitBabyRenderer {
	public static class ModelRegisterHandler {
		@SubscribeEvent
		@OnlyIn(Dist.CLIENT)
		public void registerModels(ModelRegistryEvent event) {
			RenderingRegistry.registerEntityRenderingHandler(WildRabbitBabyEntity.entity, renderManager -> {
				return new MobRenderer(renderManager, new ModelRabbitBaby(), 0.35f) {
					@Override
					public ResourceLocation getEntityTexture(Entity entity) {
						return new ResourceLocation("wildfarmcraft:textures/rabbitwildbaby.png");
					}
				};
			});
		}
	 ...
	 */
	public static class ModelRabbitBaby extends EntityModel<Entity> {
		...
		public void render(MatrixStack ms, IVertexBuilder vb, int i1, int i2, float f1, float f2, float f3, float f4) {
			...
			this.RightFrontLeg.render(ms, vb, i1, i2, f1, f2, f3, f4);
			this.LeftBackLeg.render(ms, vb, i1, i2, f1, f2, f3, f4);
			this.ANIMATEHEAD.render(ms, vb, i1, i2, f1, f2, f3, f4);
			this.RightBackLeg.render(ms, vb, i1, i2, f1, f2, f3, f4);
			this.LeftFrontLeg.render(ms, vb, i1, i2, f1, f2, f3, f4);
		}
