...
@OnlyIn(Dist.CLIENT)
public class BrownDuckMaleRenderer {
	public static class ModelRegisterHandler {
		@SubscribeEvent
		@OnlyIn(Dist.CLIENT)
		public void registerModels(ModelRegistryEvent event) {
			RenderingRegistry.registerEntityRenderingHandler(BrownDuckMaleEntity.entity, renderManager -> {
				return new MobRenderer(renderManager, new ModelDuckDomesticMale(), 0.4f) {
					@Override
					public ResourceLocation getEntityTexture(Entity entity) {
						return new ResourceLocation("wildfarmcraft:textures/brownduckmale.png");
					}
				};
			});
		}
