...
@OnlyIn(Dist.CLIENT)
public class DomesticTurkeyFemaleRenderer {
	public static class ModelRegisterHandler {
		@SubscribeEvent
		@OnlyIn(Dist.CLIENT)
		public void registerModels(ModelRegistryEvent event) {
			RenderingRegistry.registerEntityRenderingHandler(DomesticTurkeyFemaleEntity.entity, renderManager -> {
				return new MobRenderer(renderManager, new ModelTurkeyDomesticFemale(), 0.4f) {
					@Override
					public ResourceLocation getEntityTexture(Entity entity) {
						return new ResourceLocation("wildfarmcraft:textures/turkeydomesticfemale.png");
					}
				};
			});
		}
	...
	/**
	 * TurkeyDomesticFemale - Matheus Created using Tabula 7.1.0
	 */
	public static class ModelTurkeyDomesticFemale extends EntityModel<Entity> {
		...
		public ModelTurkeyDomesticFemale() {
			...
			this.body3.setRotationPoint(-3.0F, 13.0F, 2.0F);
			...
			this.Tail2.setRotationPoint(0.1F, 15.3F, 7.0F);
			...
			this.body.setRotationPoint(0.5F, 12.0F, -2.8F);
			this.body.addBox(-4.0F, 0.0F, 0.0F, 7, 7, 9, 0.0F);
			this.setRotateAngle(body, -0.07435102613495843F, -0.0F, 0.0F);
			this.Tail1 = new ModelRenderer(this, 16, 0);
			this.Tail1.setRotationPoint(-1.0F, 15.0F, 7.2F);
			...
			this.Tail3.setRotationPoint(-1.9F, 15.3F, 6.5F);
