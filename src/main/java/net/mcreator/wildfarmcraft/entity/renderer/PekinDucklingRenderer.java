...
@OnlyIn(Dist.CLIENT)
public class PekinDucklingRenderer {
	public static class ModelRegisterHandler {
		@SubscribeEvent
		@OnlyIn(Dist.CLIENT)
		public void registerModels(ModelRegistryEvent event) {
			RenderingRegistry.registerEntityRenderingHandler(PekinDucklingEntity.entity, renderManager -> {
				return new MobRenderer(renderManager, new ModelDuckBrownBaby(), 0.35f) {
					@Override
					public ResourceLocation getEntityTexture(Entity entity) {
						return new ResourceLocation("wildfarmcraft:textures/domesticduckling.png");
					}
				};
			});
		}
	...
	/**
	 * DuckBrownBaby - Matheus Created using Tabula 7.1.0
	 */
	public static class ModelDuckBrownBaby extends EntityModel<Entity> {
		...
		public ModelDuckBrownBaby() {
			this.textureWidth = 64;
			this.textureHeight = 32;
			this.beak = new ModelRenderer(this, 35, 0);
			this.beak.mirror = true;
			this.beak.setRotationPoint(-1.01F, -1.9F, -4.0F);
			this.beak.addBox(0.0F, 0.0F, 0.0F, 1, 1, 2, 0.0F);
			this.setRotateAngle(beak, 0.296705972839036F, 0.0F, 0.0F);
			...
			this.head.setRotationPoint(0.5F, -2.1F, 0.0F);
			this.head.addBox(-1.5F, -3.0F, -3.0F, 2, 2, 2, 0.0F);
			this.setRotateAngle(head, 0.9075712110370513F, 0.0F, 0.0F);
			this.neck2 = new ModelRenderer(this, 0, 10);
			this.neck2.setRotationPoint(-0.51F, -2.4F, -1.9F);
			this.neck2.addBox(0.0F, 0.0F, 0.0F, 1, 2, 2, 0.0F);
			this.setRotateAngle(neck2, -0.6283185307179586F, 0.0F, 0.0F);
			...
			this.beak2.setRotationPoint(-1.0F, -1.9F, -4.1F);
			...
			this.body2.setRotationPoint(0.5F, 0.1F, 4.0F);
			...
			this.setRotateAngle(neck, -0.9075712110370513F, 0.0F, 0.0F);
