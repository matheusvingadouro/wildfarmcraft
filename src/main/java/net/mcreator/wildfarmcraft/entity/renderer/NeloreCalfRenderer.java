...
@OnlyIn(Dist.CLIENT)
public class NeloreCalfRenderer {
	public static class ModelRegisterHandler {
		@SubscribeEvent
		@OnlyIn(Dist.CLIENT)
		public void registerModels(ModelRegistryEvent event) {
			RenderingRegistry.registerEntityRenderingHandler(NeloreCalfEntity.entity, renderManager -> {
				return new MobRenderer(renderManager, new ModelNeloreCalf(), 0.9f) {
					@Override
					public ResourceLocation getEntityTexture(Entity entity) {
						return new ResourceLocation("wildfarmcraft:textures/nelorecalf.png");
					}
				};
			});
		}
	...
	/**
	 * NeloreCalf - Matheus Created using Tabula 7.1.0
	 */
	public static class ModelNeloreCalf extends EntityModel<Entity> {
		...
		public ModelNeloreCalf() {
			...
			this.LeftEar.setRotationPoint(5.7F, 0.7F, -3.8F);
			...
			this.RightEar.setRotationPoint(-2.8F, 0.1F, -3.8F);
