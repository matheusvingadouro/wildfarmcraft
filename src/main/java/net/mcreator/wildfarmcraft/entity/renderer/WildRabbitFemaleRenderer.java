...
@OnlyIn(Dist.CLIENT)
public class WildRabbitFemaleRenderer {
	public static class ModelRegisterHandler {
		@SubscribeEvent
		@OnlyIn(Dist.CLIENT)
		public void registerModels(ModelRegistryEvent event) {
			RenderingRegistry.registerEntityRenderingHandler(WildRabbitFemaleEntity.entity, renderManager -> {
				return new MobRenderer(renderManager, new ModelRabbitWildFemale(), 0.4f) {
					@Override
					public ResourceLocation getEntityTexture(Entity entity) {
						return new ResourceLocation("wildfarmcraft:textures/rabbitwildfemale.png");
					}
				};
			});
		}
	...
	/**
	 * RabbitWildFemale - Matheus Created using Tabula 7.1.0
	 */
	public static class ModelRabbitWildFemale extends EntityModel<Entity> {
