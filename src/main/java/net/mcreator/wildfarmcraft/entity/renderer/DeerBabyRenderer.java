...
public class DeerBabyRenderer {
	public static class ModelRegisterHandler {
		...
		public void registerModels(ModelRegistryEvent event) {
			RenderingRegistry.registerEntityRenderingHandler(DeerBabyEntity.entity, renderManager -> {
				return new MobRenderer(renderManager, new ModelDeerBaby(), 0.6f) {
					@Override
					public ResourceLocation getEntityTexture(Entity entity) {
						return new ResourceLocation("wildfarmcraft:textures/deerbaby.png");
					}
				};
			});
		}
	...
	/**
	 * DeerBaby - Matheus Created using Tabula 7.1.0
	 */
	public static class ModelDeerBaby extends EntityModel<Entity> {
		...
		public ModelDeerBaby() {
			this.textureWidth = 128;
			this.textureHeight = 128;
			this.ear1 = new ModelRenderer(this, 18, 0);
			this.ear1.setRotationPoint(3.0F, -1.0F, -1.7F);
			this.ear1.addBox(0.0F, 0.0F, 0.0F, 1, 3, 1, 0.0F);
			this.setRotateAngle(ear1, 0.0F, 0.0F, 0.9599310885968813F);
			this.Tail = new ModelRenderer(this, 14, 17);
			this.Tail.setRotationPoint(-0.5F, 12.2F, 5.2F);
			...
			this.ear2.setRotationPoint(-3.6F, -0.3F, -1.7F);
			this.ear2.addBox(0.0F, 0.0F, 0.0F, 1, 3, 1, 0.0F);
			this.setRotateAngle(ear2, 0.0F, 0.0F, -0.9599310885968813F);
