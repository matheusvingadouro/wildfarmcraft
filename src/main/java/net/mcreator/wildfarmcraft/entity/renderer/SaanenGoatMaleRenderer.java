...
@OnlyIn(Dist.CLIENT)
public class SaanenGoatMaleRenderer {
	public static class ModelRegisterHandler {
		@SubscribeEvent
		@OnlyIn(Dist.CLIENT)
		public void registerModels(ModelRegistryEvent event) {
			RenderingRegistry.registerEntityRenderingHandler(SaanenGoatMaleEntity.entity, renderManager -> {
				return new MobRenderer(renderManager, new ModelSaanenGoatMale(), 0.7f) {
					@Override
					public ResourceLocation getEntityTexture(Entity entity) {
						return new ResourceLocation("wildfarmcraft:textures/saanengoatmale.png");
					}
				};
			});
		}
	...
	/**
	 * SaanenGoatMale - Matheus Created using Tabula 7.1.0
	 */
	public static class ModelSaanenGoatMale extends EntityModel<Entity> {
		...
		public ModelSaanenGoatMale() {
			this.textureWidth = 128;
			this.textureHeight = 128;
			this.LeftHorn4 = new ModelRenderer(this, 0, 45);
			this.LeftHorn4.setRotationPoint(2.8F, -0.1F, -0.6F);
			this.LeftHorn4.addBox(0.0F, 0.0F, 0.0F, 3, 1, 1, 0.0F);
			this.setRotateAngle(LeftHorn4, 0.0F, -0.3490658503988659F, 0.3490658503988659F);
			...
			this.LeftHorn1.setRotationPoint(1.1F, -0.6F, -3.0F);
			this.LeftHorn1.addBox(-3.0F, -1.0F, -1.0F, 5, 2, 2, 0.0F);
			this.setRotateAngle(LeftHorn1, 0.0F, 2.443460952792061F, -1.2217304763960306F);
			...
			this.RightHorn3.setRotationPoint(-1.9F, 1.2F, 0.05F);
			...
			this.setRotateAngle(RightHorn1, 0.0F, 0.6981317007977318F, 1.2217304763960306F);
			...
			this.RightHorn4.setRotationPoint(2.6F, -0.1F, -0.4F);
			this.RightHorn4.addBox(0.0F, 0.0F, 0.0F, 3, 1, 1, 0.0F);
			this.setRotateAngle(RightHorn4, 0.0F, 0.3490658503988659F, 0.3490658503988659F);
			...
			this.LeftHorn3.setRotationPoint(-1.8F, 1.2F, -0.05F);
