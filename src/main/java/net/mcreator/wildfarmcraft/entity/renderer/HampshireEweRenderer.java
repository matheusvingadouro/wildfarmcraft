...
@OnlyIn(Dist.CLIENT)
public class HampshireEweRenderer {
	public static class ModelRegisterHandler {
		@SubscribeEvent
		@OnlyIn(Dist.CLIENT)
		public void registerModels(ModelRegistryEvent event) {
			RenderingRegistry.registerEntityRenderingHandler(HampshireEweEntity.entity, renderManager -> {
				return new MobRenderer(renderManager, new ModelHampshireEwe(), 0.7000000000000001f) {
					@Override
					public ResourceLocation getEntityTexture(Entity entity) {
						return new ResourceLocation("wildfarmcraft:textures/hampshireewe.png");
					}
				};
			});
		}
	...
	/**
	 * HampshireEwe - Matheus Created using Tabula 7.1.0
	 */
	public static class ModelHampshireEwe extends EntityModel<Entity> {
