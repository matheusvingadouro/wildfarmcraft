...
@OnlyIn(Dist.CLIENT)
public class BoarSowRenderer {
	public static class ModelRegisterHandler {
		@SubscribeEvent
		@OnlyIn(Dist.CLIENT)
		public void registerModels(ModelRegistryEvent event) {
			RenderingRegistry.registerEntityRenderingHandler(BoarSowEntity.entity, renderManager -> {
				return new MobRenderer(renderManager, new ModelBoarFemale(), 0.7000000000000001f) {
					@Override
					public ResourceLocation getEntityTexture(Entity entity) {
						return new ResourceLocation("wildfarmcraft:textures/boarfemale.png");
					}
				};
			});
		}
	...
	/**
	 * BoarFemale - Matheus Created using Tabula 7.1.0
	 */
	public static class ModelBoarFemale extends EntityModel<Entity> {
		...
		public ModelBoarFemale() {
			...
			this.head5.setRotationPoint(-2.5F, -4.5F, -7.0F);
			...
			this.neck2.setRotationPoint(-1.5F, -6.3F, -4.8F);
			...
			this.body.setRotationPoint(0.5F, 17.5F, -7.5F);
