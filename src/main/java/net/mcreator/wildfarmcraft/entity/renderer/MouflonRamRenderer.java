...
@OnlyIn(Dist.CLIENT)
public class MouflonRamRenderer {
	public static class ModelRegisterHandler {
		@SubscribeEvent
		@OnlyIn(Dist.CLIENT)
		public void registerModels(ModelRegistryEvent event) {
			RenderingRegistry.registerEntityRenderingHandler(MouflonRamEntity.entity, renderManager -> {
				return new MobRenderer(renderManager, new ModelMouflonRam(), 0.7f) {
					@Override
					public ResourceLocation getEntityTexture(Entity entity) {
						return new ResourceLocation("wildfarmcraft:textures/mouflonram.png");
					}
				};
			});
		}
	 ...
	 */
	public static class ModelMouflonRam extends EntityModel<Entity> {
