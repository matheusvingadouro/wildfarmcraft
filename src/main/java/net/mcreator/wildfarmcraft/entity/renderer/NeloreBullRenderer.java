...
@OnlyIn(Dist.CLIENT)
public class NeloreBullRenderer {
	public static class ModelRegisterHandler {
		@SubscribeEvent
		@OnlyIn(Dist.CLIENT)
		public void registerModels(ModelRegistryEvent event) {
			RenderingRegistry.registerEntityRenderingHandler(NeloreBullEntity.entity, renderManager -> {
				return new MobRenderer(renderManager, new ModelNeloreBull(), 0.9f) {
					@Override
					public ResourceLocation getEntityTexture(Entity entity) {
						return new ResourceLocation("wildfarmcraft:textures/nelorebull.png");
					}
				};
			});
		}
	...
	/**
	 * NeloreBull - Matheus Created using Tabula 7.1.0
	 */
	public static class ModelNeloreBull extends EntityModel<Entity> {
