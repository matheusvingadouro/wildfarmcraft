...
@OnlyIn(Dist.CLIENT)
public class HolsteinBullRenderer {
	public static class ModelRegisterHandler {
		@SubscribeEvent
		@OnlyIn(Dist.CLIENT)
		public void registerModels(ModelRegistryEvent event) {
			RenderingRegistry.registerEntityRenderingHandler(HolsteinBullEntity.entity, renderManager -> {
				return new MobRenderer(renderManager, new ModelHolsteinBullParented(), 0.9f) {
					@Override
					public ResourceLocation getEntityTexture(Entity entity) {
						return new ResourceLocation("wildfarmcraft:textures/holsteinbull.png");
					}
				};
			});
		}
	...
	/**
	 * HolsteinBullParented - Matheus Created using Tabula 7.1.0
	 */
	public static class ModelHolsteinBullParented extends EntityModel<Entity> {
		...
		public ModelHolsteinBullParented() {
			...
			this.Body4.setRotationPoint(1.0F, -0.9F, 0.0F);
			...
			this.setRotateAngle(Neck2, -0.6867870606597687F, 0.0F, 0.0F);
			...
			this.Neck.setRotationPoint(1.0F, 1.9F, 0.6F);
			...
			this.LeftHorn2.setRotationPoint(-2.2F, 0.0F, -0.5F);
			...
			this.RightHorn2.setRotationPoint(-2.3F, 0.0F, -0.5F);
			...
			this.Collar2 = new ModelRenderer(this, 22, 116);
			this.Collar2.setRotationPoint(-3.0F, -0.8F, -3.8F);
			this.Collar2.addBox(0.0F, 0.0F, 0.0F, 6, 4, 2, 0.0F);
			this.setRotateAngle(Collar2, -0.5410520681182421F, 0.0F, 0.0F);
			...
			this.Collar = new ModelRenderer(this, 0, 116);
			this.Collar.setRotationPoint(-4.0F, -7.0F, -4.8F);
			this.Collar.addBox(0.0F, 0.0F, 0.0F, 8, 8, 2, 0.0F);
			this.setRotateAngle(Collar, 0.05235987755982988F, 0.0F, 0.0F);
			...
			this.setRotateAngle(Body5, -0.08726646259971647F, 0.0F, 0.0F);
