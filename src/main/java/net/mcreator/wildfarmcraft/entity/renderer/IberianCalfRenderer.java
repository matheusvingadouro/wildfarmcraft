...
@OnlyIn(Dist.CLIENT)
public class IberianCalfRenderer {
	public static class ModelRegisterHandler {
		@SubscribeEvent
		@OnlyIn(Dist.CLIENT)
		public void registerModels(ModelRegistryEvent event) {
			RenderingRegistry.registerEntityRenderingHandler(IberianCalfEntity.entity, renderManager -> {
				return new MobRenderer(renderManager, new ModelAurochsCalf(), 0.9f) {
					@Override
					public ResourceLocation getEntityTexture(Entity entity) {
						return new ResourceLocation("wildfarmcraft:textures/ibericcalf.png");
					}
				};
			});
		}
