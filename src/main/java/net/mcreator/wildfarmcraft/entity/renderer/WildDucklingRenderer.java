...
@OnlyIn(Dist.CLIENT)
public class WildDucklingRenderer {
	public static class ModelRegisterHandler {
		@SubscribeEvent
		@OnlyIn(Dist.CLIENT)
		public void registerModels(ModelRegistryEvent event) {
			RenderingRegistry.registerEntityRenderingHandler(WildDucklingEntity.entity, renderManager -> {
				return new MobRenderer(renderManager, new ModelDuckBrownBaby(), 0.35f) {
					@Override
					public ResourceLocation getEntityTexture(Entity entity) {
						return new ResourceLocation("wildfarmcraft:textures/wildduckling.png");
					}
				};
			});
		}
