...
@OnlyIn(Dist.CLIENT)
public class BoarPigletRenderer {
	public static class ModelRegisterHandler {
		@SubscribeEvent
		@OnlyIn(Dist.CLIENT)
		public void registerModels(ModelRegistryEvent event) {
			RenderingRegistry.registerEntityRenderingHandler(BoarPigletEntity.entity, renderManager -> {
				return new MobRenderer(renderManager, new ModelBoarBaby(), 0.6f) {
					@Override
					public ResourceLocation getEntityTexture(Entity entity) {
						return new ResourceLocation("wildfarmcraft:textures/boarbaby.png");
					}
				};
			});
		}
	...
	/**
	 * BoarBaby - Matheus Created using Tabula 7.1.0
	 */
	public static class ModelBoarBaby extends EntityModel<Entity> {
		...
		public ModelBoarBaby() {
			this.textureWidth = 128;
			this.textureHeight = 128;
			this.Tail2 = new ModelRenderer(this, 14, 22);
			this.Tail2.setRotationPoint(0.02F, 0.0F, 1.7F);
			...
			this.head2.setRotationPoint(-2.0F, -0.9F, -8.7F);
			this.head2.addBox(-1.0F, -1.0F, 1.0F, 2, 2, 3, 0.0F);
			this.setRotateAngle(head2, 0.6981317007977318F, -0.0F, 0.0F);
			this.leftear2 = new ModelRenderer(this, 18, 3);
			this.leftear2.setRotationPoint(1.8F, 0.5F, -0.02F);
			...
			this.rightear2.setRotationPoint(-0.8F, 0.5F, -0.02F);
			...
			this.neck.setRotationPoint(0.0F, 1.8F, 1.2F);
			...
			this.setRotateAngle(Tail, -0.8203047484373349F, -0.0F, 0.0F);
