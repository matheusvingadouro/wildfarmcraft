...
@OnlyIn(Dist.CLIENT)
public class PekinDuckMaleRenderer {
	public static class ModelRegisterHandler {
		@SubscribeEvent
		@OnlyIn(Dist.CLIENT)
		public void registerModels(ModelRegistryEvent event) {
			RenderingRegistry.registerEntityRenderingHandler(PekinDuckMaleEntity.entity, renderManager -> {
				return new MobRenderer(renderManager, new ModelDuckDomesticMale(), 0.4f) {
					@Override
					public ResourceLocation getEntityTexture(Entity entity) {
						return new ResourceLocation("wildfarmcraft:textures/domesticduckmale.png");
					}
				};
			});
		}
	 ...
	 */
	public static class ModelDuckDomesticMale extends EntityModel<Entity> {
