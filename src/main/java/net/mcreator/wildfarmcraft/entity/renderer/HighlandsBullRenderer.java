...
@OnlyIn(Dist.CLIENT)
public class HighlandsBullRenderer {
	public static class ModelRegisterHandler {
		@SubscribeEvent
		@OnlyIn(Dist.CLIENT)
		public void registerModels(ModelRegistryEvent event) {
			RenderingRegistry.registerEntityRenderingHandler(HighlandsBullEntity.entity, renderManager -> {
				return new MobRenderer(renderManager, new ModelHighlandsBull(), 0.9f) {
					@Override
					public ResourceLocation getEntityTexture(Entity entity) {
						return new ResourceLocation("wildfarmcraft:textures/highlandsbull.png");
					}
				};
			});
		}
	...
	/**
	 * HighlandsBull - Matheus Created using Tabula 7.1.0
	 */
	public static class ModelHighlandsBull extends EntityModel<Entity> {
		...
		public ModelHighlandsBull() {
			...
			this.NeckFur.setRotationPoint(2.5F, 1.2F, 2.7F);
			this.NeckFur.addBox(0.0F, 0.0F, 0.0F, 1, 6, 14, 0.0F);
			this.setRotateAngle(NeckFur, -0.5410520681182421F, 0.0F, 0.0F);
			...
			this.Neck2.addChild(this.NeckFur);
