...
@OnlyIn(Dist.CLIENT)
public class LeghornRoosterRenderer {
	public static class ModelRegisterHandler {
		@SubscribeEvent
		@OnlyIn(Dist.CLIENT)
		public void registerModels(ModelRegistryEvent event) {
			RenderingRegistry.registerEntityRenderingHandler(LeghornRoosterEntity.entity, renderManager -> {
				return new MobRenderer(renderManager, new ModelLeghornRooster(), 0.4f) {
					@Override
					public ResourceLocation getEntityTexture(Entity entity) {
						return new ResourceLocation("wildfarmcraft:textures/leghornrooster.png");
					}
				};
			});
		}
