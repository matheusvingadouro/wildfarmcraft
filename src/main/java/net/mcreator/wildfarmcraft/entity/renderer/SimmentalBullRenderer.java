...
@OnlyIn(Dist.CLIENT)
public class SimmentalBullRenderer {
	public static class ModelRegisterHandler {
		@SubscribeEvent
		@OnlyIn(Dist.CLIENT)
		public void registerModels(ModelRegistryEvent event) {
			RenderingRegistry.registerEntityRenderingHandler(SimmentalBullEntity.entity, renderManager -> {
				return new MobRenderer(renderManager, new ModelSimmentalBull(), 0.9f) {
					@Override
					public ResourceLocation getEntityTexture(Entity entity) {
						return new ResourceLocation("wildfarmcraft:textures/simmentalbull.png");
					}
				};
			});
		}
	...
	/**
	 * SimmentalBull - Matheus Created using Tabula 7.1.0
	 */
	public static class ModelSimmentalBull extends EntityModel<Entity> {
