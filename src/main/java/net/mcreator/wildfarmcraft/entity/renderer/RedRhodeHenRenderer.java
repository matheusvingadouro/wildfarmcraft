...
@OnlyIn(Dist.CLIENT)
public class RedRhodeHenRenderer {
	public static class ModelRegisterHandler {
		@SubscribeEvent
		@OnlyIn(Dist.CLIENT)
		public void registerModels(ModelRegistryEvent event) {
			RenderingRegistry.registerEntityRenderingHandler(RedRhodeHenEntity.entity, renderManager -> {
				return new MobRenderer(renderManager, new ModelRedRhodeHen(), 0.5f) {
					@Override
					public ResourceLocation getEntityTexture(Entity entity) {
						return new ResourceLocation("wildfarmcraft:textures/redrhodehen.png");
					}
				};
			});
		}
	...
	/**
	 * RedRhodeHen - Matheus Created using Tabula 7.1.0
	 */
	public static class ModelRedRhodeHen extends EntityModel<Entity> {
		...
		public ModelRedRhodeHen() {
			...
			this.Body1.setRotationPoint(0.0F, 20.3F, 0.0F);
			...
			this.animatehead.setRotationPoint(0.0F, 18.5F, -3.0F);
			...
			this.Body2.setRotationPoint(0.0F, 0.3F, 1.0F);
			this.Body2.addBox(-2.5F, -3.13F, -4.0F, 5, 5, 4, 0.0F);
			this.setRotateAngle(Body2, -0.47123889803846897F, -0.0F, 0.0F);
