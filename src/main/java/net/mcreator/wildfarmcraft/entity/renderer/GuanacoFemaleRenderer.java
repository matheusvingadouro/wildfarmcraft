...
@OnlyIn(Dist.CLIENT)
public class GuanacoFemaleRenderer {
	public static class ModelRegisterHandler {
		@SubscribeEvent
		@OnlyIn(Dist.CLIENT)
		public void registerModels(ModelRegistryEvent event) {
			RenderingRegistry.registerEntityRenderingHandler(GuanacoFemaleEntity.entity, renderManager -> {
				return new MobRenderer(renderManager, new ModelGuanacoFemale(), 0.7000000000000001f) {
					@Override
					public ResourceLocation getEntityTexture(Entity entity) {
						return new ResourceLocation("wildfarmcraft:textures/guanacofemale.png");
					}
				};
			});
		}
	...
	/**
	 * GuanacoFemale - Matheus Created using Tabula 7.1.0
	 */
	public static class ModelGuanacoFemale extends EntityModel<Entity> {
