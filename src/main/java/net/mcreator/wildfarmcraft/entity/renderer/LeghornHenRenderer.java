...
@OnlyIn(Dist.CLIENT)
public class LeghornHenRenderer {
	public static class ModelRegisterHandler {
		@SubscribeEvent
		@OnlyIn(Dist.CLIENT)
		public void registerModels(ModelRegistryEvent event) {
			RenderingRegistry.registerEntityRenderingHandler(LeghornHenEntity.entity, renderManager -> {
				return new MobRenderer(renderManager, new ModelLeghornHen(), 0.4f) {
					@Override
					public ResourceLocation getEntityTexture(Entity entity) {
						return new ResourceLocation("wildfarmcraft:textures/leghornhen.png");
					}
				};
			});
		}
