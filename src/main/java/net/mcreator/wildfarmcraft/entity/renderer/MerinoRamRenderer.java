...
@OnlyIn(Dist.CLIENT)
public class MerinoRamRenderer {
	public static class ModelRegisterHandler {
		@SubscribeEvent
		@OnlyIn(Dist.CLIENT)
		public void registerModels(ModelRegistryEvent event) {
			RenderingRegistry.registerEntityRenderingHandler(MerinoRamEntity.entity, renderManager -> {
				return new MobRenderer(renderManager, new ModelMerinoRam(), 0.7f) {
					@Override
					public ResourceLocation getEntityTexture(Entity entity) {
						return new ResourceLocation("wildfarmcraft:textures/merinoram.png");
					}
				};
			});
		}
	...
	/**
	 * MerinoRam - Matheus Created using Tabula 7.1.0
	 */
	public static class ModelMerinoRam extends EntityModel<Entity> {
