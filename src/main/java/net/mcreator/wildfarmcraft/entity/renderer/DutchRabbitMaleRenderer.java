...
@OnlyIn(Dist.CLIENT)
public class DutchRabbitMaleRenderer {
	public static class ModelRegisterHandler {
		@SubscribeEvent
		@OnlyIn(Dist.CLIENT)
		public void registerModels(ModelRegistryEvent event) {
			RenderingRegistry.registerEntityRenderingHandler(DutchRabbitMaleEntity.entity, renderManager -> {
				return new MobRenderer(renderManager, new ModelRabbitWildMale(), 0.4f) {
					@Override
					public ResourceLocation getEntityTexture(Entity entity) {
						return new ResourceLocation("wildfarmcraft:textures/rabbitmale.png");
					}
				};
			});
		}
