...
@OnlyIn(Dist.CLIENT)
public class AurochsCalfRenderer {
	public static class ModelRegisterHandler {
		@SubscribeEvent
		@OnlyIn(Dist.CLIENT)
		public void registerModels(ModelRegistryEvent event) {
			RenderingRegistry.registerEntityRenderingHandler(AurochsCalfEntity.entity, renderManager -> {
				return new MobRenderer(renderManager, new ModelAurochsCalf(), 0.9f) {
					@Override
					public ResourceLocation getEntityTexture(Entity entity) {
						return new ResourceLocation("wildfarmcraft:textures/aurochscalf.png");
					}
				};
			});
		}
	...
	/**
	 * AurochsCalf - Matheus Created using Tabula 7.1.0
	 */
	public static class ModelAurochsCalf extends EntityModel<Entity> {
		...
		public ModelAurochsCalf() {
			...
			this.LeftHorn = new ModelRenderer(this, 0, 40);
			this.LeftHorn.setRotationPoint(1.3F, 1.2F, -4.6F);
			this.LeftHorn.addBox(0.0F, -0.5F, -0.5F, 3, 1, 1, 0.0F);
			this.setRotateAngle(LeftHorn, 0.0F, 0.0F, -0.8726646259971648F);
			...
			this.RightHorn = new ModelRenderer(this, 0, 40);
			this.RightHorn.setRotationPoint(-1.3F, 1.2F, -4.6F);
			this.RightHorn.addBox(0.0F, -0.5F, -0.5F, 3, 1, 1, 0.0F);
			this.setRotateAngle(RightHorn, 0.0F, 0.0F, -2.2689280275926285F);
