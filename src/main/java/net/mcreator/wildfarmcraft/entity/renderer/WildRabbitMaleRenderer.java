...
@OnlyIn(Dist.CLIENT)
public class WildRabbitMaleRenderer {
	public static class ModelRegisterHandler {
		@SubscribeEvent
		@OnlyIn(Dist.CLIENT)
		public void registerModels(ModelRegistryEvent event) {
			RenderingRegistry.registerEntityRenderingHandler(WildRabbitMaleEntity.entity, renderManager -> {
				return new MobRenderer(renderManager, new ModelRabbitWildMale(), 0.4f) {
					@Override
					public ResourceLocation getEntityTexture(Entity entity) {
						return new ResourceLocation("wildfarmcraft:textures/rabbitwildmale.png");
					}
				};
			});
		}
	...
	/**
	 * RabbitWildMale - Matheus Created using Tabula 7.1.0
	 */
	public static class ModelRabbitWildMale extends EntityModel<Entity> {
		...
		public ModelRabbitWildMale() {
			...
			this.neck.setRotationPoint(-1.0F, 2.5F, 1.1F);
			this.neck.addBox(-1.5F, -1.5F, -6.0F, 5, 4, 4, 0.0F);
			...
			this.ANIMATEHEAD.setRotationPoint(0.0F, 18.6F, -0.4F);
			...
			this.Tail.setRotationPoint(0.0F, 19.8F, 4.8F);
			...
			this.head.setRotationPoint(1.0F, -2.0F, -7.5F);
			...
			this.Body.setRotationPoint(0.0F, 20.2F, 8.0F);
