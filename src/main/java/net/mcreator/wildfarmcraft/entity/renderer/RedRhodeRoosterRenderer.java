...
@OnlyIn(Dist.CLIENT)
public class RedRhodeRoosterRenderer {
	public static class ModelRegisterHandler {
		@SubscribeEvent
		@OnlyIn(Dist.CLIENT)
		public void registerModels(ModelRegistryEvent event) {
			RenderingRegistry.registerEntityRenderingHandler(RedRhodeRoosterEntity.entity, renderManager -> {
				return new MobRenderer(renderManager, new ModelRedRhodeRooster(), 0.5f) {
					@Override
					public ResourceLocation getEntityTexture(Entity entity) {
						return new ResourceLocation("wildfarmcraft:textures/redrhoderooster.png");
					}
				};
			});
		}
	...
	/**
	 * RedRhodeRooster - Matheus Created using Tabula 7.1.0
	 */
	public static class ModelRedRhodeRooster extends EntityModel<Entity> {
		...
		public ModelRedRhodeRooster() {
			...
			this.Neck.setRotationPoint(0.0F, 1.0F, -3.23F);
			...
			this.Body2.setRotationPoint(0.0F, -0.1F, 1.0F);
			this.Body2.addBox(-2.5F, -3.13F, -4.0F, 5, 5, 4, 0.0F);
			this.setRotateAngle(Body2, -0.5235987755982988F, -0.0F, 0.0F);
			...
			this.animatehead.setRotationPoint(0.0F, 18.0F, -3.0F);
			...
			this.Tailfeathers1.setRotationPoint(0.0F, 0.0F, 0.0F);
			...
			this.Beak1.setRotationPoint(0.0F, 0.3F, -0.03F);
			...
			this.Body1.addBox(-3.0F, -5.5333333015441895F, -4.0F, 6, 6, 6, 0.0F);
			this.setRotateAngle(Body1, -0.19198621809482574F, -0.0F, 0.0F);
