...
@OnlyIn(Dist.CLIENT)
public class IberianBullRenderer {
	public static class ModelRegisterHandler {
		@SubscribeEvent
		@OnlyIn(Dist.CLIENT)
		public void registerModels(ModelRegistryEvent event) {
			RenderingRegistry.registerEntityRenderingHandler(IberianBullEntity.entity, renderManager -> {
				return new MobRenderer(renderManager, new ModelIbericBull(), 0.9f) {
					@Override
					public ResourceLocation getEntityTexture(Entity entity) {
						return new ResourceLocation("wildfarmcraft:textures/ibericbull.png");
					}
				};
			});
		}
	 ...
	 */
	public static class ModelIbericBull extends EntityModel<Entity> {
