...
@OnlyIn(Dist.CLIENT)
public class HolsteinCowRenderer {
	public static class ModelRegisterHandler {
		@SubscribeEvent
		@OnlyIn(Dist.CLIENT)
		public void registerModels(ModelRegistryEvent event) {
			RenderingRegistry.registerEntityRenderingHandler(HolsteinCowEntity.entity, renderManager -> {
				return new MobRenderer(renderManager, new ModelHolsteinCow(), 0.9f) {
					@Override
					public ResourceLocation getEntityTexture(Entity entity) {
						return new ResourceLocation("wildfarmcraft:textures/holsteincow.png");
					}
				};
			});
		}
	...
	/**
	 * HolsteinCow - Matheus Created using Tabula 7.1.0
	 */
	public static class ModelHolsteinCow extends EntityModel<Entity> {
		...
		public ModelHolsteinCow() {
			...
			this.Collar.addBox(0.0F, 0.0F, 0.0F, 8, 8, 1, 0.0F);
			...
			this.Collar2.setRotationPoint(-0.5F, 0.2F, -5.5F);
			...
			this.Bell.setRotationPoint(-1.0F, 1.0F, -5.8F);
