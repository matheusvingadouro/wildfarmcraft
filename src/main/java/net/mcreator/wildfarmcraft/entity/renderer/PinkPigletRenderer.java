...
@OnlyIn(Dist.CLIENT)
public class PinkPigletRenderer {
	public static class ModelRegisterHandler {
		@SubscribeEvent
		@OnlyIn(Dist.CLIENT)
		public void registerModels(ModelRegistryEvent event) {
			RenderingRegistry.registerEntityRenderingHandler(PinkPigletEntity.entity, renderManager -> {
				return new MobRenderer(renderManager, new ModelPigBaby(), 0.6f) {
					@Override
					public ResourceLocation getEntityTexture(Entity entity) {
						return new ResourceLocation("wildfarmcraft:textures/pigbaby.png");
					}
				};
			});
		}
