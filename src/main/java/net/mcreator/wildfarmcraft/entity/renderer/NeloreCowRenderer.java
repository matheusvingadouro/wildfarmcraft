...
@OnlyIn(Dist.CLIENT)
public class NeloreCowRenderer {
	public static class ModelRegisterHandler {
		@SubscribeEvent
		@OnlyIn(Dist.CLIENT)
		public void registerModels(ModelRegistryEvent event) {
			RenderingRegistry.registerEntityRenderingHandler(NeloreCowEntity.entity, renderManager -> {
				return new MobRenderer(renderManager, new ModelNeloreCow(), 0.9f) {
					@Override
					public ResourceLocation getEntityTexture(Entity entity) {
						return new ResourceLocation("wildfarmcraft:textures/nelorecow.png");
					}
				};
			});
		}
	...
	/**
	 * NeloreCow - Matheus Created using Tabula 7.1.0
	 */
	public static class ModelNeloreCow extends EntityModel<Entity> {
		...
		public ModelNeloreCow() {
			...
			this.Head4.addBox(-3.0F, 0.0F, -0.0F, 6, 1, 5, 0.0F);
			...
			this.RightEar.setRotationPoint(-4.4F, 0.9F, -2.8F);
			this.RightEar.addBox(-3.0F, 0.0F, 0.0F, 5, 3, 1, 0.0F);
			...
			this.LeftHorn2.setRotationPoint(-1.3F, 0.3F, -0.7F);
			this.LeftHorn2.addBox(-3.0F, 0.0F, -0.5F, 2, 1, 1, 0.0F);
			this.setRotateAngle(LeftHorn2, 0.0F, 0.24434609527920614F, 0.4970697709679851F);
			this.udders = new ModelRenderer(this, 86, 33);
			this.udders.setRotationPoint(4.0F, 13.0F, -1.0F);
			...
			this.LeftEar.setRotationPoint(6.7F, 1.5F, -2.8F);
			this.LeftEar.addBox(-3.0F, 0.0F, 0.0F, 5, 3, 1, 0.0F);
			...
			this.RightHorn2.addBox(-2.0F, 0.0F, -0.5F, 2, 1, 1, 0.0F);
			this.setRotateAngle(RightHorn2, 0.0F, -0.24434609527920614F, 0.4970697709679851F);
			this.LeftHorn1 = new ModelRenderer(this, 0, 40);
			this.LeftHorn1.setRotationPoint(3.1F, 0.4F, -4.2F);
			this.LeftHorn1.addBox(-3.0F, -1.0F, -1.0F, 3, 2, 1, 0.0F);
			this.setRotateAngle(LeftHorn1, 0.0F, 2.356194490192345F, -0.8726646259971648F);
			...
			this.RightHorn1 = new ModelRenderer(this, 0, 40);
			this.RightHorn1.setRotationPoint(-1.8F, 0.8F, -3.4F);
			this.RightHorn1.addBox(-3.0F, -1.0F, -1.0F, 3, 2, 1, 0.0F);
			this.setRotateAngle(RightHorn1, 0.0F, 0.7853981633974483F, 0.8726646259971648F);
