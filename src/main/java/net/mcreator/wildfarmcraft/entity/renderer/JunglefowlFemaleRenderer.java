...
@OnlyIn(Dist.CLIENT)
public class JunglefowlFemaleRenderer {
	public static class ModelRegisterHandler {
		@SubscribeEvent
		@OnlyIn(Dist.CLIENT)
		public void registerModels(ModelRegistryEvent event) {
			RenderingRegistry.registerEntityRenderingHandler(JunglefowlFemaleEntity.entity, renderManager -> {
				return new MobRenderer(renderManager, new ModelLeghornHen(), 0.4f) {
					@Override
					public ResourceLocation getEntityTexture(Entity entity) {
						return new ResourceLocation("wildfarmcraft:textures/junglefowlfemale.png");
					}
				};
			});
		}
	 ...
	 */
	public static class ModelLeghornHen extends EntityModel<Entity> {
