...
@OnlyIn(Dist.CLIENT)
public class WildTurkeyBabyRenderer {
	public static class ModelRegisterHandler {
		@SubscribeEvent
		@OnlyIn(Dist.CLIENT)
		public void registerModels(ModelRegistryEvent event) {
			RenderingRegistry.registerEntityRenderingHandler(WildTurkeyBabyEntity.entity, renderManager -> {
				return new MobRenderer(renderManager, new ModelLeghornChick(), 0.35f) {
					@Override
					public ResourceLocation getEntityTexture(Entity entity) {
						return new ResourceLocation("wildfarmcraft:textures/turkeywildbaby.png");
					}
				};
			});
		}
