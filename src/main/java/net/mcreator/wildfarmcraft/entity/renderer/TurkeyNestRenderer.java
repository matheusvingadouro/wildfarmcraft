...
@OnlyIn(Dist.CLIENT)
public class TurkeyNestRenderer {
	public static class ModelRegisterHandler {
		@SubscribeEvent
		@OnlyIn(Dist.CLIENT)
		public void registerModels(ModelRegistryEvent event) {
			RenderingRegistry.registerEntityRenderingHandler(TurkeyNestEntity.entity, renderManager -> {
				return new MobRenderer(renderManager, new Modelnestturkey(), 0f) {
					@Override
					public ResourceLocation getEntityTexture(Entity entity) {
						return new ResourceLocation("wildfarmcraft:textures/nestturkey.png");
					}
				};
			});
		}
	...
	/**
	 * nestturkey - Matheus Created using Tabula 7.1.0
	 */
	public static class Modelnestturkey extends EntityModel<Entity> {
		...
		public Modelnestturkey() {
			this.textureWidth = 64;
			this.textureHeight = 64;
			this.egg3 = new ModelRenderer(this, 48, 8);
			this.egg3.setRotationPoint(-2.6F, 20.8F, -1.3F);
			this.egg3.addBox(0.0F, 0.0F, 0.0F, 2, 3, 2, 0.0F);
			...
			this.egg2.setRotationPoint(1.3F, 20.4F, -3.5F);
			this.egg2.addBox(0.0F, 0.0F, 0.0F, 2, 3, 2, 0.0F);
			...
			this.egg1.setRotationPoint(0.9F, 19.9F, 0.6F);
