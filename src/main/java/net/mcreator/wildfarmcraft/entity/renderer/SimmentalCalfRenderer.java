...
@OnlyIn(Dist.CLIENT)
public class SimmentalCalfRenderer {
	public static class ModelRegisterHandler {
		@SubscribeEvent
		@OnlyIn(Dist.CLIENT)
		public void registerModels(ModelRegistryEvent event) {
			RenderingRegistry.registerEntityRenderingHandler(SimmentalCalfEntity.entity, renderManager -> {
				return new MobRenderer(renderManager, new ModelHolsteinCalf(), 0.9f) {
					@Override
					public ResourceLocation getEntityTexture(Entity entity) {
						return new ResourceLocation("wildfarmcraft:textures/simmentalcalf.png");
					}
				};
			});
		}
	...
	/**
	 * HolsteinCalf - Matheus Created using Tabula 7.1.0
	 */
