...
@OnlyIn(Dist.CLIENT)
public class PekinDuckFemaleRenderer {
	public static class ModelRegisterHandler {
		@SubscribeEvent
		@OnlyIn(Dist.CLIENT)
		public void registerModels(ModelRegistryEvent event) {
			RenderingRegistry.registerEntityRenderingHandler(PekinDuckFemaleEntity.entity, renderManager -> {
				return new MobRenderer(renderManager, new ModelDuckDomesticFemale(), 0.4f) {
					@Override
					public ResourceLocation getEntityTexture(Entity entity) {
						return new ResourceLocation("wildfarmcraft:textures/domesticduckfemale.png");
					}
				};
			});
		}
