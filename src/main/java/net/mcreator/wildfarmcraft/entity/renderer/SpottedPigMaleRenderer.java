...
@OnlyIn(Dist.CLIENT)
public class SpottedPigMaleRenderer {
	public static class ModelRegisterHandler {
		@SubscribeEvent
		@OnlyIn(Dist.CLIENT)
		public void registerModels(ModelRegistryEvent event) {
			RenderingRegistry.registerEntityRenderingHandler(SpottedPigMaleEntity.entity, renderManager -> {
				return new MobRenderer(renderManager, new ModelPigMale(), 0.7f) {
					@Override
					public ResourceLocation getEntityTexture(Entity entity) {
						return new ResourceLocation("wildfarmcraft:textures/spottedpigmale.png");
					}
				};
			});
		}
	...
	/**
	 * PigMale - Matheus Created using Tabula 7.1.0
	 */
	public static class ModelPigMale extends EntityModel<Entity> {
