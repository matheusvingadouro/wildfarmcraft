...
import net.mcreator.wildfarmcraft.procedures.SimmentalCowTickUpdateProcedure;
...
import net.mcreator.wildfarmcraft.entity.renderer.SimmentalCowRenderer;
...
public class SimmentalCowEntity extends WildfarmcraftModElements.ModElement {
	public static EntityType entity = (EntityType.Builder.<CustomEntity>create(CustomEntity::new, EntityClassification.CREATURE)
			.setShouldReceiveVelocityUpdates(true).setTrackingRange(64).setUpdateInterval(3).setCustomClientFactory(CustomEntity::new)
			.size(0.9f, 1.6f)).build("simmental_cow").setRegistryName("simmental_cow");
	public SimmentalCowEntity(WildfarmcraftModElements instance) {
		super(instance, 343);
		FMLJavaModLoadingContext.get().getModEventBus().register(new SimmentalCowRenderer.ModelRegisterHandler());
	...
	public void initElements() {
		...
		elements.items.add(() -> new SpawnEggItem(entity, -2897215, -6984381, new Item.Properties().group(WildFarmCraftSpawnEggsItemGroup.tab))
				.setRegistryName("simmental_cow_spawn_egg"));
	}
	...
	public static class CustomEntity extends TameableEntity {
		...
		public void baseTick() {
			...
			Entity entity = this;
			{
				...
				SimmentalCowTickUpdateProcedure.executeProcedure($_dependencies);
			}
		}
