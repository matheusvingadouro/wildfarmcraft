...
import net.mcreator.wildfarmcraft.procedures.HampshireRamTickUpdateProcedure;
...
import net.mcreator.wildfarmcraft.entity.renderer.HampshireRamRenderer;
...
public class HampshireRamEntity extends WildfarmcraftModElements.ModElement {
	public static EntityType entity = (EntityType.Builder.<CustomEntity>create(CustomEntity::new, EntityClassification.CREATURE)
			.setShouldReceiveVelocityUpdates(true).setTrackingRange(64).setUpdateInterval(3).setCustomClientFactory(CustomEntity::new)
			.size(0.9f, 1.2f)).build("hampshire_ram").setRegistryName("hampshire_ram");
	public HampshireRamEntity(WildfarmcraftModElements instance) {
		super(instance, 6);
		FMLJavaModLoadingContext.get().getModEventBus().register(new HampshireRamRenderer.ModelRegisterHandler());
	...
	public void initElements() {
		...
		elements.items.add(() -> new SpawnEggItem(entity, -14671840, -2436406, new Item.Properties().group(WildFarmCraftSpawnEggsItemGroup.tab))
				.setRegistryName("hampshire_ram_spawn_egg"));
	}
	...
	public static class CustomEntity extends TameableEntity {
		...
		public void baseTick() {
			...
			Entity entity = this;
			{
				...
				HampshireRamTickUpdateProcedure.executeProcedure($_dependencies);
			}
		}
