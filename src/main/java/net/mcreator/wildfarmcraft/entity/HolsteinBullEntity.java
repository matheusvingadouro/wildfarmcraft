...
import net.mcreator.wildfarmcraft.procedures.HolsteinBullOnEntityTickUpdateProcedure;
...
import net.mcreator.wildfarmcraft.entity.renderer.HolsteinBullRenderer;
...
public class HolsteinBullEntity extends WildfarmcraftModElements.ModElement {
	public static EntityType entity = (EntityType.Builder.<CustomEntity>create(CustomEntity::new, EntityClassification.CREATURE)
			.setShouldReceiveVelocityUpdates(true).setTrackingRange(64).setUpdateInterval(3).setCustomClientFactory(CustomEntity::new)
			.size(0.9f, 1.6f)).build("holstein_bull").setRegistryName("holstein_bull");
	public HolsteinBullEntity(WildfarmcraftModElements instance) {
		super(instance, 3);
		FMLJavaModLoadingContext.get().getModEventBus().register(new HolsteinBullRenderer.ModelRegisterHandler());
	...
	public void initElements() {
		...
		elements.items.add(() -> new SpawnEggItem(entity, -2897215, -14869219, new Item.Properties().group(WildFarmCraftSpawnEggsItemGroup.tab))
				.setRegistryName("holstein_bull_spawn_egg"));
	}
	...
	public static class CustomEntity extends TameableEntity {
		...
		public void baseTick() {
			...
			Entity entity = this;
			{
				...
				HolsteinBullOnEntityTickUpdateProcedure.executeProcedure($_dependencies);
			}
		}
