...
import net.mcreator.wildfarmcraft.procedures.HampshireEweTickUpdateProcedure;
...
import net.mcreator.wildfarmcraft.entity.renderer.HampshireEweRenderer;
...
public class HampshireEweEntity extends WildfarmcraftModElements.ModElement {
	public static EntityType entity = (EntityType.Builder.<CustomEntity>create(CustomEntity::new, EntityClassification.CREATURE)
			.setShouldReceiveVelocityUpdates(true).setTrackingRange(64).setUpdateInterval(3).setCustomClientFactory(CustomEntity::new)
			.size(0.9f, 1.2f)).build("hampshire_ewe").setRegistryName("hampshire_ewe");
	public HampshireEweEntity(WildfarmcraftModElements instance) {
		super(instance, 5);
		FMLJavaModLoadingContext.get().getModEventBus().register(new HampshireEweRenderer.ModelRegisterHandler());
	...
	public void initElements() {
		...
		elements.items.add(() -> new SpawnEggItem(entity, -14671840, -2436406, new Item.Properties().group(WildFarmCraftSpawnEggsItemGroup.tab))
				.setRegistryName("hampshire_ewe_spawn_egg"));
	}
	...
	public static class CustomEntity extends TameableEntity {
		...
		public void baseTick() {
			...
			Entity entity = this;
			{
				...
				HampshireEweTickUpdateProcedure.executeProcedure($_dependencies);
			}
		}
