...
import net.mcreator.wildfarmcraft.procedures.PinkSowTickUpdateProcedure;
...
import net.mcreator.wildfarmcraft.entity.renderer.PinkSowRenderer;
...
public class PinkSowEntity extends WildfarmcraftModElements.ModElement {
	public static EntityType entity = (EntityType.Builder.<CustomEntity>create(CustomEntity::new, EntityClassification.CREATURE)
			.setShouldReceiveVelocityUpdates(true).setTrackingRange(64).setUpdateInterval(3).setCustomClientFactory(CustomEntity::new)
			.size(0.9f, 1.0999999999999999f)).build("pink_sow").setRegistryName("pink_sow");
	public PinkSowEntity(WildfarmcraftModElements instance) {
		super(instance, 8);
		FMLJavaModLoadingContext.get().getModEventBus().register(new PinkSowRenderer.ModelRegisterHandler());
	...
	public void initElements() {
		...
		elements.items.add(() -> new SpawnEggItem(entity, -2586237, -2586237, new Item.Properties().group(WildFarmCraftSpawnEggsItemGroup.tab))
				.setRegistryName("pink_sow_spawn_egg"));
	}
	...
	public static class CustomEntity extends TameableEntity {
		...
		public void baseTick() {
			...
			Entity entity = this;
			{
				...
				PinkSowTickUpdateProcedure.executeProcedure($_dependencies);
			}
		}
