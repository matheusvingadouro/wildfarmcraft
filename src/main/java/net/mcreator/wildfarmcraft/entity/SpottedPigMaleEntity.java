...
import net.mcreator.wildfarmcraft.procedures.SpottedPigMaleTickUpdateProcedure;
...
import net.mcreator.wildfarmcraft.entity.renderer.SpottedPigMaleRenderer;
...
public class SpottedPigMaleEntity extends WildfarmcraftModElements.ModElement {
	public static EntityType entity = (EntityType.Builder.<CustomEntity>create(CustomEntity::new, EntityClassification.CREATURE)
			.setShouldReceiveVelocityUpdates(true).setTrackingRange(64).setUpdateInterval(3).setCustomClientFactory(CustomEntity::new)
			.size(0.9f, 1.0999999999999999f)).build("spotted_pig_male").setRegistryName("spotted_pig_male");
	public SpottedPigMaleEntity(WildfarmcraftModElements instance) {
		super(instance, 402);
		FMLJavaModLoadingContext.get().getModEventBus().register(new SpottedPigMaleRenderer.ModelRegisterHandler());
	...
	public void initElements() {
		...
		elements.items.add(() -> new SpawnEggItem(entity, -2586237, -2586237, new Item.Properties().group(WildFarmCraftSpawnEggsItemGroup.tab))
				.setRegistryName("spotted_pig_male_spawn_egg"));
	}
	...
	public static class CustomEntity extends TameableEntity {
		...
		public void baseTick() {
			...
			Entity entity = this;
			{
				...
				SpottedPigMaleTickUpdateProcedure.executeProcedure($_dependencies);
			}
		}
