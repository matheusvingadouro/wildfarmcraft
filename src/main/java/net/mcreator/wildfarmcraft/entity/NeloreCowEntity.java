...
import net.mcreator.wildfarmcraft.procedures.NeloreCowTickUpdateProcedure;
...
import net.mcreator.wildfarmcraft.entity.renderer.NeloreCowRenderer;
...
public class NeloreCowEntity extends WildfarmcraftModElements.ModElement {
	public static EntityType entity = (EntityType.Builder.<CustomEntity>create(CustomEntity::new, EntityClassification.CREATURE)
			.setShouldReceiveVelocityUpdates(true).setTrackingRange(64).setUpdateInterval(3).setCustomClientFactory(CustomEntity::new)
			.size(0.9f, 1.6f)).build("nelore_cow").setRegistryName("nelore_cow");
	public NeloreCowEntity(WildfarmcraftModElements instance) {
		super(instance, 135);
		FMLJavaModLoadingContext.get().getModEventBus().register(new NeloreCowRenderer.ModelRegisterHandler());
	...
	public void initElements() {
		...
		elements.items.add(() -> new SpawnEggItem(entity, -2897215, -2897215, new Item.Properties().group(WildFarmCraftSpawnEggsItemGroup.tab))
				.setRegistryName("nelore_cow_spawn_egg"));
	}
	...
	public static class CustomEntity extends TameableEntity {
		...
		public void baseTick() {
			...
			Entity entity = this;
			{
				...
				NeloreCowTickUpdateProcedure.executeProcedure($_dependencies);
			}
		}
