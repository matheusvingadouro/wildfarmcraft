...
import net.mcreator.wildfarmcraft.procedures.AurochsCowTickUpdateProcedure;
...
import net.mcreator.wildfarmcraft.entity.renderer.AurochsCowRenderer;
...
public class AurochsCowEntity extends WildfarmcraftModElements.ModElement {
	public static EntityType entity = (EntityType.Builder.<CustomEntity>create(CustomEntity::new, EntityClassification.CREATURE)
			.setShouldReceiveVelocityUpdates(true).setTrackingRange(64).setUpdateInterval(3).setCustomClientFactory(CustomEntity::new)
			.size(1.2000000000000002f, 1.7000000000000002f)).build("aurochs_cow").setRegistryName("aurochs_cow");
	public AurochsCowEntity(WildfarmcraftModElements instance) {
		super(instance, 108);
		FMLJavaModLoadingContext.get().getModEventBus().register(new AurochsCowRenderer.ModelRegisterHandler());
	...
	public void initElements() {
		...
		elements.items.add(() -> new SpawnEggItem(entity, -9878751, -13295087, new Item.Properties().group(WildFarmCraftSpawnEggsItemGroup.tab))
				.setRegistryName("aurochs_cow_spawn_egg"));
	}
	...
	public static class CustomEntity extends TameableEntity {
		...
		public void baseTick() {
			...
			Entity entity = this;
			{
				...
				AurochsCowTickUpdateProcedure.executeProcedure($_dependencies);
			}
		}
