...
import net.mcreator.wildfarmcraft.procedures.LeghornRoosterTickUpdateProcedure;
...
import net.mcreator.wildfarmcraft.entity.renderer.LeghornRoosterRenderer;
...
public class LeghornRoosterEntity extends WildfarmcraftModElements.ModElement {
	public static EntityType entity = (EntityType.Builder.<CustomEntity>create(CustomEntity::new, EntityClassification.CREATURE)
			.setShouldReceiveVelocityUpdates(true).setTrackingRange(64).setUpdateInterval(3).setCustomClientFactory(CustomEntity::new)
			.size(0.4f, 0.6f)).build("leghorn_rooster").setRegistryName("leghorn_rooster");
	public LeghornRoosterEntity(WildfarmcraftModElements instance) {
		super(instance, 184);
		FMLJavaModLoadingContext.get().getModEventBus().register(new LeghornRoosterRenderer.ModelRegisterHandler());
	...
	public void initElements() {
		...
		elements.items.add(() -> new SpawnEggItem(entity, -2896957, -4974311, new Item.Properties().group(WildFarmCraftSpawnEggsItemGroup.tab))
				.setRegistryName("leghorn_rooster_spawn_egg"));
	}
	...
	public static class CustomEntity extends TameableEntity {
		...
		public void baseTick() {
			...
			Entity entity = this;
			{
				...
				LeghornRoosterTickUpdateProcedure.executeProcedure($_dependencies);
			}
		}
