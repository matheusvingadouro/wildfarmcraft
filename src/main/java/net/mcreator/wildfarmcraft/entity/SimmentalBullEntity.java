...
import net.mcreator.wildfarmcraft.procedures.SimmentalBullTickUpdateProcedure;
...
import net.mcreator.wildfarmcraft.entity.renderer.SimmentalBullRenderer;
...
public class SimmentalBullEntity extends WildfarmcraftModElements.ModElement {
	public static EntityType entity = (EntityType.Builder.<CustomEntity>create(CustomEntity::new, EntityClassification.CREATURE)
			.setShouldReceiveVelocityUpdates(true).setTrackingRange(64).setUpdateInterval(3).setCustomClientFactory(CustomEntity::new)
			.size(0.9f, 1.6f)).build("simmental_bull").setRegistryName("simmental_bull");
	public SimmentalBullEntity(WildfarmcraftModElements instance) {
		super(instance, 344);
		FMLJavaModLoadingContext.get().getModEventBus().register(new SimmentalBullRenderer.ModelRegisterHandler());
	...
	public void initElements() {
		...
		elements.items.add(() -> new SpawnEggItem(entity, -2897215, -6984381, new Item.Properties().group(WildFarmCraftSpawnEggsItemGroup.tab))
				.setRegistryName("simmental_bull_spawn_egg"));
	}
	...
	public static class CustomEntity extends TameableEntity {
		...
		public void baseTick() {
			...
			Entity entity = this;
			{
				...
				SimmentalBullTickUpdateProcedure.executeProcedure($_dependencies);
			}
		}
