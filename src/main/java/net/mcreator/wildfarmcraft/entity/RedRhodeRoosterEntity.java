...
import net.mcreator.wildfarmcraft.procedures.RedRhodeRoosterTickUpdateProcedure;
...
import net.mcreator.wildfarmcraft.entity.renderer.RedRhodeRoosterRenderer;
...
public class RedRhodeRoosterEntity extends WildfarmcraftModElements.ModElement {
	public static EntityType entity = (EntityType.Builder.<CustomEntity>create(CustomEntity::new, EntityClassification.CREATURE)
			.setShouldReceiveVelocityUpdates(true).setTrackingRange(64).setUpdateInterval(3).setCustomClientFactory(CustomEntity::new)
			.size(0.5f, 0.7f)).build("red_rhode_rooster").setRegistryName("red_rhode_rooster");
	public RedRhodeRoosterEntity(WildfarmcraftModElements instance) {
		super(instance, 396);
		FMLJavaModLoadingContext.get().getModEventBus().register(new RedRhodeRoosterRenderer.ModelRegisterHandler());
	...
	public void initElements() {
		...
		elements.items.add(() -> new SpawnEggItem(entity, -10408941, -4974311, new Item.Properties().group(WildFarmCraftSpawnEggsItemGroup.tab))
				.setRegistryName("red_rhode_rooster_spawn_egg"));
	}
	...
	public static class CustomEntity extends TameableEntity {
		...
		public void baseTick() {
			...
			Entity entity = this;
			{
				...
				RedRhodeRoosterTickUpdateProcedure.executeProcedure($_dependencies);
			}
		}
