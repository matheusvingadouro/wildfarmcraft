...
import net.mcreator.wildfarmcraft.procedures.NeloreBullTickUpdateProcedure;
...
import net.mcreator.wildfarmcraft.entity.renderer.NeloreBullRenderer;
...
public class NeloreBullEntity extends WildfarmcraftModElements.ModElement {
	public static EntityType entity = (EntityType.Builder.<CustomEntity>create(CustomEntity::new, EntityClassification.CREATURE)
			.setShouldReceiveVelocityUpdates(true).setTrackingRange(64).setUpdateInterval(3).setCustomClientFactory(CustomEntity::new)
			.size(0.9f, 1.6f)).build("nelore_bull").setRegistryName("nelore_bull");
	public NeloreBullEntity(WildfarmcraftModElements instance) {
		super(instance, 136);
		FMLJavaModLoadingContext.get().getModEventBus().register(new NeloreBullRenderer.ModelRegisterHandler());
	...
	public void initElements() {
		...
		elements.items.add(() -> new SpawnEggItem(entity, -2897215, -2897215, new Item.Properties().group(WildFarmCraftSpawnEggsItemGroup.tab))
				.setRegistryName("nelore_bull_spawn_egg"));
	}
	...
	public static class CustomEntity extends TameableEntity {
		...
		public void baseTick() {
			...
			Entity entity = this;
			{
				...
				NeloreBullTickUpdateProcedure.executeProcedure($_dependencies);
			}
		}
