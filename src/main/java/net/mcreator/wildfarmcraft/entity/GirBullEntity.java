...
import net.mcreator.wildfarmcraft.procedures.GirBullTickUpdateProcedure;
...
import net.mcreator.wildfarmcraft.entity.renderer.GirBullRenderer;
...
public class GirBullEntity extends WildfarmcraftModElements.ModElement {
	public static EntityType entity = (EntityType.Builder.<CustomEntity>create(CustomEntity::new, EntityClassification.CREATURE)
			.setShouldReceiveVelocityUpdates(true).setTrackingRange(64).setUpdateInterval(3).setCustomClientFactory(CustomEntity::new)
			.size(0.9f, 1.6f)).build("gir_bull").setRegistryName("gir_bull");
	public GirBullEntity(WildfarmcraftModElements instance) {
		super(instance, 353);
		FMLJavaModLoadingContext.get().getModEventBus().register(new GirBullRenderer.ModelRegisterHandler());
	...
	public void initElements() {
		...
		elements.items.add(() -> new SpawnEggItem(entity, -10535904, -2897215, new Item.Properties().group(WildFarmCraftSpawnEggsItemGroup.tab))
				.setRegistryName("gir_bull_spawn_egg"));
	}
	...
	public static class CustomEntity extends TameableEntity {
		...
		public void baseTick() {
			...
			Entity entity = this;
			{
				...
				GirBullTickUpdateProcedure.executeProcedure($_dependencies);
			}
		}
