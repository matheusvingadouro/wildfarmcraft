 ...
 */
public static class Modelnestturkey extends ModelBase {
	...
	public void render(Entity entity, float f, float f1, float f2, float f3, float f4, float f5) {
		this.egg3.render(f5);
		this.straw2.render(f5);
		this.egg2.render(f5);
		this.straw1.render(f5);
		this.straw4.render(f5);
		this.egg1.render(f5);
		this.straw3.render(f5);
		this.straw5.render(f5);
	}
